...
impl Lc {
    ...
    #[cfg(all(feature = "biophys-lc", not(feature = "biophys-l4-lc")))]
    pub fn new_micro(config: CircuitConfig) -> Self {
    ...
    #[cfg(feature = "biophys-l4-lc")]
    pub fn new_micro(config: CircuitConfig) -> Self {
        use microcircuit_lc_l4::LcMicrocircuit;
...
mod tests {
    ...
    #[cfg(feature = "biophys-l4-lc")]
    #[test]
    fn receipt_invalid_invariant_holds_for_l4_biophys() {
        let mut lc = Lc::new_micro(CircuitConfig::default());
        let output = lc.tick(&LcInput {
            receipt_invalid_count_short: 1,
            ..base_input()
    ...
    #[cfg(feature = "biophys-l4-lc")]
    #[test]
    fn integrity_fail_forces_high_for_l4_biophys() {
        let mut lc = Lc::new_micro(CircuitConfig::default());
        let output = lc.tick(&LcInput {
            integrity: IntegrityState::Fail,
            ..base_input()
    ...
    #[cfg(feature = "biophys-l4-lc")]
    #[test]
    fn l4_biophys_is_no_less_conservative_than_rules_for_critical_inputs() {
        fn severity(level: LevelClass) -> u8 {
            match level {
                LevelClass::Low => 0,
                LevelClass::Med => 1,
