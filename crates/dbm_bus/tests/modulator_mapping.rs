...
fn reward_block_forces_da_low() {
    let mods =
        modulator_field_from_levels(LevelClass::Med, LevelClass::Low, LevelClass::High, true);
...
fn reward_block_allows_da_progress() {
    let mods =
        modulator_field_from_levels(LevelClass::Low, LevelClass::High, LevelClass::High, false);
