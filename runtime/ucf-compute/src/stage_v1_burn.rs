...
const BURN_WORLD_BACKEND_ID: u16 = 402;
...
#[derive(Debug, Clone)]
pub struct BurnWorldAdapterV0 {
    mlp: Option<WorldMlp>,
}

impl BurnWorldAdapterV0 {
...
mod tests {
    use super::*;
    use crate::stage_v1::StageErrorCode;
    ...
    fn deterministic_forward_and_disabled_path() {
        ...
        mlp.w1[0] = 0.5;
        mlp.w2[0] = 0.5;
        let model = BurnWorldAdapterV0 { mlp: Some(mlp) };
        ...
        let disabled = BurnWorldAdapterV0::disabled();
