...
pub use blue_brain_region_first_integration::{
    ...
    BlueBrainHhReadinessClass, BlueBrainHhReadinessDecisionEntry, BlueBrainHhReadinessSurfaceKind,
    ...
    CANONICAL_BLUE_BRAIN_FIRST_REGION_INTEGRATION_MAP, CANONICAL_BLUE_BRAIN_HH_READINESS_CLASS_MAP,
