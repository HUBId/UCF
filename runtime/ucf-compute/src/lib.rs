...
pub use service_surface::{
    ...
    ComputeSubmitOutcome, ComputeSubmitRequest, DecisionJustificationDisposition,
    DecisionJustificationView, JustificationEvidencePosture, RecoveredJobStatus,
    RecoveryDisposition, ReplayConfigurationDiff, ReplayContextBridgeSummary,
