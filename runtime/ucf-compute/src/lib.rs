...
pub use reference_map::{
    ...
    FirstDomainRolloutCompletionStatus, CANONICAL_COMPUTE_INTEGRATION_CONTRACT_VIEW,
    ...
    CANONICAL_FIRST_DOMAIN_ROLLOUT_COMPLETION_MAP, FINAL_REFERENCE_LINE_CROSS_CUTTING_INVARIANTS,
