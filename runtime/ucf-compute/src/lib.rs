...
pub use service_surface::{
    ...
    ReplayExecutionMode, ReplayFailureCode, ReplayMismatchCategory, ReplayMismatchClass,
    ReplayMismatchReason, ReplayMismatchReasonCode, ReplayMismatchView, ReplayOutcomeComparison,
    ...
    RolloutReplayComparisonContext, RolloutReplayContextClass, RuntimeBoundedRecoveryView,
    RuntimeOperation, RuntimeOperationClass, RuntimeOperationCode, RuntimeOperationOutcome,
