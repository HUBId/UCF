...
pub use reference_map::{
    ...
    canonical_blue_brain_integration_map, canonical_compute_integration_contract_view,
    ...
    BlueBrainComputeHandoffClass, BlueBrainComputeHandoffLane, BlueBrainFacingContractClass,
    BlueBrainFacingContractLane, BlueBrainIntegrationClass, BlueBrainIntegrationLane,
