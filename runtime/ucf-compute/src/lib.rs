...
pub use blue_brain_region_first_integration::{
    ...
    BlueBrainMd1DeepeningSurfaceKind, BlueBrainMd1FirstDeepeningCandidateClass,
    BlueBrainMd1FirstDeepeningDiagnosticClass, BlueBrainMd1FirstDeepeningInputSurface,
    ...
    BlueBrainMd1ModelDeepeningClass, BlueBrainMd1RegionDeepeningDecision,
    ...
    CANONICAL_BLUE_BRAIN_MD1_MODEL_DEEPENING_CLASS_MAP,
