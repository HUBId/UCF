...
pub use blue_brain_region_first_integration::{
    ...
    BlueBrainSc1SecondConsolidationActionClass, BlueBrainSecondRegionAdvisoryOutputClass,
    BlueBrainSecondRegionClass, BlueBrainSecondRegionExpansionState,
    BlueBrainSecondRegionInputGuard, BlueBrainSecondRegionInputSource,
