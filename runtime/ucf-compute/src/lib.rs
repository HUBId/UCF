...
pub use blue_brain_dynamics::{
    ...
    kuramoto_modulation_state_token, BlueBrainDynamicsAdvisoryCouplingLane,
    BlueBrainDynamicsAdvisoryCouplingState, BlueBrainDynamicsDiagnosticClass,
    BlueBrainDynamicsDiagnosticLane, BlueBrainDynamicsExecutionFeedbackLane,
    BlueBrainDynamicsExecutionFeedbackState, BlueBrainDynamicsRuntimeFeedbackClass,
    ...
    BlueBrainKuramotoSynchronyDiagnostic, CANONICAL_BLUE_BRAIN_DYNAMICS_ADVISORY_COUPLING_MAP,
