...
pub const HISTORICAL_PRIMARY_SEMANTICS_LINEAGE_BLOCKED: &str =
    "HISTORICAL_PRIMARY_SEMANTICS_LINEAGE_BLOCKED";
pub const HISTORICAL_PRIMARY_SEMANTICS_LINEAGE_TRANSLATED: &str =
    "HISTORICAL_PRIMARY_SEMANTICS_LINEAGE_TRANSLATED";
pub const HISTORICAL_PRIMARY_SEMANTICS_LINEAGE_REJECTED: &str =
    "HISTORICAL_PRIMARY_SEMANTICS_LINEAGE_REJECTED";
pub const ABSOLUTE_RESIDUAL_FREE_FINAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED: &str =
    "ABSOLUTE_RESIDUAL_FREE_FINAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED";
pub const PRIMARY_SEMANTICS_ECHO_PATH_BLOCKED: &str = "PRIMARY_SEMANTICS_ECHO_PATH_BLOCKED";
pub const PRIMARY_SEMANTICS_ECHO_PATH_TRANSLATED: &str = "PRIMARY_SEMANTICS_ECHO_PATH_TRANSLATED";
pub const PRIMARY_SEMANTICS_ECHO_PATH_REJECTED: &str = "PRIMARY_SEMANTICS_ECHO_PATH_REJECTED";
pub const TERMINAL_ABSOLUTE_RESIDUAL_FREE_FINAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED: &str =
    "TERMINAL_ABSOLUTE_RESIDUAL_FREE_FINAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED";
pub const PRIMARY_SEMANTICS_CACHE_PATH_BLOCKED: &str = "PRIMARY_SEMANTICS_CACHE_PATH_BLOCKED";
pub const PRIMARY_SEMANTICS_CACHE_PATH_TRANSLATED: &str = "PRIMARY_SEMANTICS_CACHE_PATH_TRANSLATED";
pub const PRIMARY_SEMANTICS_CACHE_PATH_REJECTED: &str = "PRIMARY_SEMANTICS_CACHE_PATH_REJECTED";
pub const PRIMARY_SEMANTICS_MEMO_PATH_BLOCKED: &str = "PRIMARY_SEMANTICS_MEMO_PATH_BLOCKED";
pub const PRIMARY_SEMANTICS_MEMO_PATH_TRANSLATED: &str = "PRIMARY_SEMANTICS_MEMO_PATH_TRANSLATED";
...
pub const FINAL_CONSOLIDATED_STABILIZED_CANONICAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED: &str =
    "FINAL_CONSOLIDATED_STABILIZED_CANONICAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED";
pub const PRIMARY_SEMANTICS_WRAPPER_PATH_BLOCKED: &str = "PRIMARY_SEMANTICS_WRAPPER_PATH_BLOCKED";
pub const PRIMARY_SEMANTICS_WRAPPER_PATH_TRANSLATED: &str =
    "PRIMARY_SEMANTICS_WRAPPER_PATH_TRANSLATED";
pub const PRIMARY_SEMANTICS_WRAPPER_PATH_REJECTED: &str = "PRIMARY_SEMANTICS_WRAPPER_PATH_REJECTED";
pub const PRIMARY_SEMANTICS_SHELL_PATH_BLOCKED: &str = "PRIMARY_SEMANTICS_SHELL_PATH_BLOCKED";
pub const PRIMARY_SEMANTICS_SHELL_PATH_TRANSLATED: &str = "PRIMARY_SEMANTICS_SHELL_PATH_TRANSLATED";
pub const PRIMARY_SEMANTICS_SHELL_PATH_REJECTED: &str = "PRIMARY_SEMANTICS_SHELL_PATH_REJECTED";
pub const CLOSURE_COMPLETE_FINAL_CONSOLIDATED_STABILIZED_CANONICAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED: &str =
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct ResidualFreePrimarySemanticsAbsoluteInputsV1 {
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
    pub canonical_primary_semantics_authority_digest_prefix: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct AbsoluteFinalPrimarySemanticsTerminalInputsV1 {
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
    pub canonical_primary_semantics_authority_digest_prefix: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct TerminalPrimarySemanticsUltimateInputsV1 {
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
    pub canonical_primary_semantics_authority_digest_prefix: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct PrimarySemanticsConvergenceInputsV1 {
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
    pub canonical_primary_semantics_authority_digest_prefix: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct PrimarySemanticsClosureInputsV1 {
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
    pub canonical_primary_semantics_authority_digest_prefix: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct PrimarySemanticsSealInputsV1 {
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
    pub canonical_primary_semantics_authority_digest_prefix: String,
...
pub fn require_residual_free_primary_semantics_absolute_inputs(
    canonical_condition_model: Option<&[String]>,
    canonical_remediation_registry: Option<&[String]>,
    canonical_primary_semantics_authority: Option<&CanonicalPrimarySemanticsAuthorityV1>,
    final_primary_semantics_consumer_authority: Option<&FinalPrimarySemanticsConsumerAuthorityV1>,
    ...
    >,
) -> Result<ResidualFreePrimarySemanticsAbsoluteInputsV1, OpsError> {
    let base = require_residual_free_final_primary_semantics_inputs(
        canonical_condition_model,
        canonical_remediation_registry,
        canonical_primary_semantics_authority,
        final_primary_semantics_consumer_authority,
    ...
    let Some(residual_free) = residual_free_primary_semantics_consumer_authority else {
        return Err(OpsError::Invalid(
            RESIDUAL_FREE_FINAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED.to_string(),
        ));
    };
    let residual_free_prefix = prefix16(&residual_free.authority_digest);
    if !matches!(
        residual_free.authority_status,
        crate::ResidualFreePrimarySemanticsAuthorityStatusV1::Pass
    ) || residual_free.canonical_governance_entry_digest_prefix
        != base.canonical_governance_entry_digest_prefix
        || residual_free.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || residual_free.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || residual_free.canonical_primary_semantics_authority_digest_prefix
            != base.canonical_primary_semantics_authority_digest_prefix
        || residual_free.final_primary_semantics_consumer_authority_digest_prefix
            != base.final_primary_semantics_consumer_authority_digest_prefix
        || residual_free.final_primary_semantics_residual_sweep_digest_prefix
            != base.final_primary_semantics_residual_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(
            HISTORICAL_PRIMARY_SEMANTICS_LINEAGE_BLOCKED.to_string(),
        ));
    }
    ...
    Ok(ResidualFreePrimarySemanticsAbsoluteInputsV1 {
        ...
        residual_free_primary_semantics_consumer_authority_digest_prefix: residual_free_prefix,
        authority_digest: sha256_hex(&payload),
    })
}

pub fn require_absolute_final_primary_semantics_terminal_inputs(
    canonical_condition_model: Option<&[String]>,
    canonical_remediation_registry: Option<&[String]>,
    canonical_primary_semantics_authority: Option<&CanonicalPrimarySemanticsAuthorityV1>,
    final_primary_semantics_consumer_authority: Option<&FinalPrimarySemanticsConsumerAuthorityV1>,
    ...
    >,
) -> Result<AbsoluteFinalPrimarySemanticsTerminalInputsV1, OpsError> {
    let base = require_residual_free_primary_semantics_absolute_inputs(
        canonical_condition_model,
        canonical_remediation_registry,
        canonical_primary_semantics_authority,
        final_primary_semantics_consumer_authority,
    ...
    let Some(absolute_sweep) = residual_free_primary_semantics_absolute_sweep else {
        return Err(OpsError::Invalid(
            ABSOLUTE_RESIDUAL_FREE_FINAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED.to_string(),
        ));
    };
    if !matches!(
        absolute_sweep.sweep_status,
        crate::ResidualFreePrimarySemanticsAbsoluteSweepStatusV1::Pass
    ) {
        return Err(OpsError::Invalid(
            PRIMARY_SEMANTICS_ECHO_PATH_BLOCKED.to_string(),
        ));
    }
    let absolute_prefix = prefix16(&absolute_sweep.sweep_digest);
    if absolute_sweep.canonical_governance_entry_digest_prefix
        != base.canonical_governance_entry_digest_prefix
        || absolute_sweep.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || absolute_sweep.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || absolute_sweep.canonical_primary_semantics_authority_digest_prefix
            != base.canonical_primary_semantics_authority_digest_prefix
        || absolute_sweep.final_primary_semantics_consumer_authority_digest_prefix
            != base.final_primary_semantics_consumer_authority_digest_prefix
        || absolute_sweep.final_primary_semantics_residual_sweep_digest_prefix
            != base.final_primary_semantics_residual_sweep_digest_prefix
        || absolute_sweep.residual_free_primary_semantics_consumer_authority_digest_prefix
    ...
    Ok(AbsoluteFinalPrimarySemanticsTerminalInputsV1 {
        canonical_governance_entry_digest_prefix: base.canonical_governance_entry_digest_prefix,
        canonical_readiness_spine_digest_prefix: base.canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: base.canonical_bundle_spine_digest_prefix,
        canonical_primary_semantics_authority_digest_prefix: base
        ...
        residual_free_primary_semantics_absolute_sweep_digest_prefix: absolute_prefix,
        authority_digest: sha256_hex(&payload),
    })
}

#[allow(clippy::too_many_arguments)]
pub fn require_terminal_primary_semantics_ultimate_inputs(
    canonical_condition_model: Option<&[String]>,
    canonical_remediation_registry: Option<&[String]>,
    canonical_primary_semantics_authority: Option<&CanonicalPrimarySemanticsAuthorityV1>,
    final_primary_semantics_consumer_authority: Option<&FinalPrimarySemanticsConsumerAuthorityV1>,
    ...
    >,
) -> Result<TerminalPrimarySemanticsUltimateInputsV1, OpsError> {
    let base = require_absolute_final_primary_semantics_terminal_inputs(
        canonical_condition_model,
        canonical_remediation_registry,
        canonical_primary_semantics_authority,
        final_primary_semantics_consumer_authority,
    ...
    let Some(terminal_sweep) = absolute_final_primary_semantics_terminal_sweep else {
        return Err(OpsError::Invalid(
            TERMINAL_ABSOLUTE_RESIDUAL_FREE_FINAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED.to_string(),
        ));
    };
    if !matches!(
        terminal_sweep.sweep_status,
        crate::AbsoluteFinalPrimarySemanticsTerminalSweepStatusV1::Pass
    ) {
        return Err(OpsError::Invalid(
            PRIMARY_SEMANTICS_CACHE_PATH_BLOCKED.to_string(),
        ));
    }

    let terminal_prefix = prefix16(&terminal_sweep.sweep_digest);
    if terminal_sweep.canonical_governance_entry_digest_prefix
        != base.canonical_governance_entry_digest_prefix
        || terminal_sweep.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || terminal_sweep.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || terminal_sweep.canonical_primary_semantics_authority_digest_prefix
            != base.canonical_primary_semantics_authority_digest_prefix
        || terminal_sweep.final_primary_semantics_consumer_authority_digest_prefix
            != base.final_primary_semantics_consumer_authority_digest_prefix
        || terminal_sweep.final_primary_semantics_residual_sweep_digest_prefix
            != base.final_primary_semantics_residual_sweep_digest_prefix
        || terminal_sweep.residual_free_primary_semantics_consumer_authority_digest_prefix
            != base.residual_free_primary_semantics_consumer_authority_digest_prefix
        || terminal_sweep.residual_free_primary_semantics_absolute_sweep_digest_prefix
    ...
    Ok(TerminalPrimarySemanticsUltimateInputsV1 {
        canonical_governance_entry_digest_prefix: base.canonical_governance_entry_digest_prefix,
        canonical_readiness_spine_digest_prefix: base.canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: base.canonical_bundle_spine_digest_prefix,
        canonical_primary_semantics_authority_digest_prefix: base
        ...
        absolute_final_primary_semantics_terminal_sweep_digest_prefix: terminal_prefix,
        authority_digest: sha256_hex(&payload),
    })
}

#[allow(clippy::too_many_arguments)]
pub fn require_primary_semantics_convergence_inputs(
    canonical_condition_model: Option<&[String]>,
    canonical_remediation_registry: Option<&[String]>,
    canonical_primary_semantics_authority: Option<&CanonicalPrimarySemanticsAuthorityV1>,
    final_primary_semantics_consumer_authority: Option<&FinalPrimarySemanticsConsumerAuthorityV1>,
    ...
    >,
) -> Result<PrimarySemanticsConvergenceInputsV1, OpsError> {
    let base = require_terminal_primary_semantics_ultimate_inputs(
        canonical_condition_model,
        canonical_remediation_registry,
        canonical_primary_semantics_authority,
        final_primary_semantics_consumer_authority,
    ...
    .map_err(|_| {
        OpsError::Invalid(ULTIMATE_TERMINAL_ABSOLUTE_PRIMARY_SEMANTICS_INPUTS_REQUIRED.to_string())
    })?;

    let Some(ultimate_sweep) = terminal_primary_semantics_ultimate_sweep else {
        return Err(OpsError::Invalid(
            ULTIMATE_TERMINAL_ABSOLUTE_PRIMARY_SEMANTICS_INPUTS_REQUIRED.to_string(),
        ));
    };
    if !matches!(
        ultimate_sweep.sweep_status,
        crate::TerminalPrimarySemanticsUltimateSweepStatusV1::Pass
    ) {
        return Err(OpsError::Invalid(
            PRIMARY_SEMANTICS_MEMO_PATH_BLOCKED.to_string(),
        ));
    }
    let ultimate_prefix = prefix16(&ultimate_sweep.sweep_digest);
    if ultimate_sweep.canonical_governance_entry_digest_prefix
        != base.canonical_governance_entry_digest_prefix
        || ultimate_sweep.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || ultimate_sweep.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || ultimate_sweep.canonical_primary_semantics_authority_digest_prefix
            != base.canonical_primary_semantics_authority_digest_prefix
        || ultimate_sweep.final_primary_semantics_consumer_authority_digest_prefix
            != base.final_primary_semantics_consumer_authority_digest_prefix
        || ultimate_sweep.final_primary_semantics_residual_sweep_digest_prefix
            != base.final_primary_semantics_residual_sweep_digest_prefix
        || ultimate_sweep.residual_free_primary_semantics_consumer_authority_digest_prefix
            != base.residual_free_primary_semantics_consumer_authority_digest_prefix
        || ultimate_sweep.residual_free_primary_semantics_absolute_sweep_digest_prefix
            != base.residual_free_primary_semantics_absolute_sweep_digest_prefix
        || ultimate_sweep.absolute_final_primary_semantics_terminal_sweep_digest_prefix
    ...
    Ok(PrimarySemanticsConvergenceInputsV1 {
        canonical_governance_entry_digest_prefix: base.canonical_governance_entry_digest_prefix,
        canonical_readiness_spine_digest_prefix: base.canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: base.canonical_bundle_spine_digest_prefix,
        canonical_primary_semantics_authority_digest_prefix: base
...
#[allow(clippy::too_many_arguments)]
pub fn require_primary_semantics_closure_inputs(
    canonical_condition_model: Option<&[String]>,
    canonical_remediation_registry: Option<&[String]>,
    canonical_primary_semantics_authority: Option<&CanonicalPrimarySemanticsAuthorityV1>,
    final_primary_semantics_consumer_authority: Option<&FinalPrimarySemanticsConsumerAuthorityV1>,
    ...
    primary_semantics_convergence_sweep: Option<&crate::PrimarySemanticsConvergenceSweepV1>,
    primary_semantics_stabilization_sweep: Option<&crate::PrimarySemanticsStabilizationSweepV1>,
    primary_semantics_final_consolidation_sweep: Option<
        &crate::PrimarySemanticsFinalConsolidationSweepV1,
    >,
) -> Result<PrimarySemanticsClosureInputsV1, OpsError> {
    let base = require_primary_semantics_final_consolidation_inputs(
        canonical_condition_model,
        canonical_remediation_registry,
        canonical_primary_semantics_authority,
        final_primary_semantics_consumer_authority,
        ...
        terminal_primary_semantics_ultimate_sweep,
        primary_semantics_convergence_sweep,
        primary_semantics_stabilization_sweep,
    )
    .map_err(|_| {
        OpsError::Invalid(
            FINAL_CONSOLIDATED_STABILIZED_CANONICAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED.to_string(),
        )
    })?;

    let Some(final_consolidation) = primary_semantics_final_consolidation_sweep else {
        return Err(OpsError::Invalid(
            FINAL_CONSOLIDATED_STABILIZED_CANONICAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED.to_string(),
        ));
    };
    if !matches!(
        final_consolidation.consolidation_status,
        crate::PrimarySemanticsFinalConsolidationStatusV1::Pass
    ) {
        return Err(OpsError::Invalid(
            PRIMARY_SEMANTICS_WRAPPER_PATH_BLOCKED.to_string(),
        ));
    }

    let final_consolidation_prefix = prefix16(&final_consolidation.consolidation_digest);
    if final_consolidation.canonical_governance_entry_digest_prefix
        != base.canonical_governance_entry_digest_prefix
        || final_consolidation.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || final_consolidation.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || final_consolidation.canonical_primary_semantics_authority_digest_prefix
            != base.canonical_primary_semantics_authority_digest_prefix
        || final_consolidation.final_primary_semantics_consumer_authority_digest_prefix
            != base.final_primary_semantics_consumer_authority_digest_prefix
        || final_consolidation.final_primary_semantics_residual_sweep_digest_prefix
            != base.final_primary_semantics_residual_sweep_digest_prefix
        || final_consolidation.residual_free_primary_semantics_consumer_authority_digest_prefix
            != base.residual_free_primary_semantics_consumer_authority_digest_prefix
        || final_consolidation.residual_free_primary_semantics_absolute_sweep_digest_prefix
            != base.residual_free_primary_semantics_absolute_sweep_digest_prefix
        || final_consolidation.absolute_final_primary_semantics_terminal_sweep_digest_prefix
            != base.absolute_final_primary_semantics_terminal_sweep_digest_prefix
        || final_consolidation.terminal_primary_semantics_ultimate_sweep_digest_prefix
            != base.terminal_primary_semantics_ultimate_sweep_digest_prefix
        || final_consolidation.primary_semantics_convergence_sweep_digest_prefix
            != base.primary_semantics_convergence_sweep_digest_prefix
        || final_consolidation.primary_semantics_stabilization_sweep_digest_prefix
            != base.primary_semantics_stabilization_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(
            PRIMARY_SEMANTICS_WRAPPER_PATH_REJECTED.to_string(),
        ));
    }
    ...
    Ok(PrimarySemanticsClosureInputsV1 {
        canonical_governance_entry_digest_prefix: base.canonical_governance_entry_digest_prefix,
        canonical_readiness_spine_digest_prefix: base.canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: base.canonical_bundle_spine_digest_prefix,
        canonical_primary_semantics_authority_digest_prefix: base
        ...
        primary_semantics_convergence_sweep_digest_prefix: base
            .primary_semantics_convergence_sweep_digest_prefix,
        primary_semantics_stabilization_sweep_digest_prefix: base
            .primary_semantics_stabilization_sweep_digest_prefix,
        primary_semantics_final_consolidation_sweep_digest_prefix: final_consolidation_prefix,
        authority_digest: sha256_hex(&payload),
    })
}

#[allow(clippy::too_many_arguments)]
pub fn require_primary_semantics_seal_inputs(
    canonical_condition_model: Option<&[String]>,
    canonical_remediation_registry: Option<&[String]>,
    canonical_primary_semantics_authority: Option<&CanonicalPrimarySemanticsAuthorityV1>,
    final_primary_semantics_consumer_authority: Option<&FinalPrimarySemanticsConsumerAuthorityV1>,
    ...
    primary_semantics_final_consolidation_sweep: Option<
        &crate::PrimarySemanticsFinalConsolidationSweepV1,
    >,
    primary_semantics_closure_sweep: Option<&crate::PrimarySemanticsClosureSweepV1>,
) -> Result<PrimarySemanticsSealInputsV1, OpsError> {
    let closure_inputs = require_primary_semantics_closure_inputs(
        canonical_condition_model,
        canonical_remediation_registry,
        canonical_primary_semantics_authority,
        final_primary_semantics_consumer_authority,
    ...
    let Some(closure) = primary_semantics_closure_sweep else {
        return Err(OpsError::Invalid(
            CLOSURE_COMPLETE_FINAL_CONSOLIDATED_STABILIZED_CANONICAL_PRIMARY_SEMANTICS_INPUTS_REQUIRED
                .to_string(),
        ));
    ...
    if !matches!(
        ...
        return Err(OpsError::Invalid(
            PRIMARY_SEMANTICS_SHELL_PATH_BLOCKED.to_string(),
        ));
    }

    let closure_prefix = prefix16(&closure.closure_digest);
    if closure.canonical_governance_entry_digest_prefix
        != closure_inputs.canonical_governance_entry_digest_prefix
        || closure.canonical_readiness_spine_digest_prefix
            != closure_inputs.canonical_readiness_spine_digest_prefix
        || closure.canonical_bundle_spine_digest_prefix
            != closure_inputs.canonical_bundle_spine_digest_prefix
        || closure.canonical_primary_semantics_authority_digest_prefix
            != closure_inputs.canonical_primary_semantics_authority_digest_prefix
        || closure.final_primary_semantics_consumer_authority_digest_prefix
            != closure_inputs.final_primary_semantics_consumer_authority_digest_prefix
        || closure.final_primary_semantics_residual_sweep_digest_prefix
            != closure_inputs.final_primary_semantics_residual_sweep_digest_prefix
        || closure.residual_free_primary_semantics_consumer_authority_digest_prefix
            != closure_inputs.residual_free_primary_semantics_consumer_authority_digest_prefix
        || closure.residual_free_primary_semantics_absolute_sweep_digest_prefix
            != closure_inputs.residual_free_primary_semantics_absolute_sweep_digest_prefix
        || closure.absolute_final_primary_semantics_terminal_sweep_digest_prefix
            != closure_inputs.absolute_final_primary_semantics_terminal_sweep_digest_prefix
        || closure.terminal_primary_semantics_ultimate_sweep_digest_prefix
            != closure_inputs.terminal_primary_semantics_ultimate_sweep_digest_prefix
        || closure.primary_semantics_convergence_sweep_digest_prefix
            != closure_inputs.primary_semantics_convergence_sweep_digest_prefix
        || closure.primary_semantics_stabilization_sweep_digest_prefix
            != closure_inputs.primary_semantics_stabilization_sweep_digest_prefix
        || closure.primary_semantics_final_consolidation_sweep_digest_prefix
            != closure_inputs.primary_semantics_final_consolidation_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(
            PRIMARY_SEMANTICS_SHELL_PATH_REJECTED.to_string(),
        ));
    }
    ...
    Ok(PrimarySemanticsSealInputsV1 {
        canonical_governance_entry_digest_prefix: closure_inputs
            .canonical_governance_entry_digest_prefix,
        canonical_readiness_spine_digest_prefix: closure_inputs
            .canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: closure_inputs.canonical_bundle_spine_digest_prefix,
        canonical_primary_semantics_authority_digest_prefix: closure_inputs
            .canonical_primary_semantics_authority_digest_prefix,
        final_primary_semantics_consumer_authority_digest_prefix: closure_inputs
            .final_primary_semantics_consumer_authority_digest_prefix,
        final_primary_semantics_residual_sweep_digest_prefix: closure_inputs
            .final_primary_semantics_residual_sweep_digest_prefix,
        residual_free_primary_semantics_consumer_authority_digest_prefix: closure_inputs
            .residual_free_primary_semantics_consumer_authority_digest_prefix,
        residual_free_primary_semantics_absolute_sweep_digest_prefix: closure_inputs
            .residual_free_primary_semantics_absolute_sweep_digest_prefix,
        absolute_final_primary_semantics_terminal_sweep_digest_prefix: closure_inputs
            .absolute_final_primary_semantics_terminal_sweep_digest_prefix,
        terminal_primary_semantics_ultimate_sweep_digest_prefix: closure_inputs
            .terminal_primary_semantics_ultimate_sweep_digest_prefix,
        primary_semantics_convergence_sweep_digest_prefix: closure_inputs
            .primary_semantics_convergence_sweep_digest_prefix,
        primary_semantics_stabilization_sweep_digest_prefix: closure_inputs
            .primary_semantics_stabilization_sweep_digest_prefix,
        primary_semantics_final_consolidation_sweep_digest_prefix: closure_inputs
            .primary_semantics_final_consolidation_sweep_digest_prefix,
        primary_semantics_closure_sweep_digest_prefix: closure_prefix,
        authority_digest: sha256_hex(&payload),
    })
}
