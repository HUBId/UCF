...
const ARTIFACT_SPECS: [ArtifactSpec; 124] = [
    ArtifactSpec {
    ...
    ArtifactSpec {
        artifact_id: "supported_scope_execution_v15",
        file_rel: "runtime/ucf-ops/src/models_lifecycle.rs",
        type_name: "SupportedScopeExecutionV15",
        enum_names: &["SupportedScopeExecutionDecisionV15"],
    },
    ArtifactSpec {
    ...
    ArtifactSpec {
        artifact_id: "bundle_closure_sweep_v1",
    ...
    ArtifactSpec {
        artifact_id: "governance_lock_sweep_v1",
        file_rel: "runtime/ucf-ops/src/governance_lock_sweep.rs",
        type_name: "GovernanceLockSweepV1",
        enum_names: &["GovernanceLockStatusV1", "GovernanceLockMismatchCategoryV1"],
    },
    ArtifactSpec {
    ...
    ArtifactSpec {
        artifact_id: "canonical_closure_continuity_authority_v1",
        file_rel: "runtime/ucf-ops/src/canonical_closure_continuity_sweep.rs",
        type_name: "CanonicalClosureContinuityAuthorityV1",
        enum_names: &["CanonicalClosureContinuityStatusV1"],
    },
    ArtifactSpec {
        artifact_id: "canonical_seal_continuity_authority_v1",
        file_rel: "runtime/ucf-ops/src/canonical_seal_continuity_sweep.rs",
        type_name: "CanonicalSealContinuityAuthorityV1",
        enum_names: &["CanonicalSealContinuityStatusV1"],
    },
    ArtifactSpec {
    ...
    ArtifactSpec {
        artifact_id: "workspace_test_report_v1",
        file_rel: "runtime/ucf-ops/src/lib.rs",
        type_name: "WorkspaceTestReport",
        enum_names: &["GateStatus"],
    },
    ArtifactSpec {
    ...
    ArtifactSpec {
        artifact_id: "primary_semantics_closure_sweep_v1",
        file_rel: "runtime/ucf-ops/src/primary_semantics_closure_sweep.rs",
        type_name: "PrimarySemanticsClosureSweepV1",
        enum_names: &[
    ...
    ArtifactSpec {
        artifact_id: "v19_gate_report_v1",
        file_rel: "runtime/ucf-ops/src/v19_gate.rs",
        type_name: "V19GateReportV1",
        enum_names: &["V19GateOverallStatus"],
    },
    ArtifactSpec {
        artifact_id: "v20_gate_report_v1",
        file_rel: "runtime/ucf-ops/src/v20_gate.rs",
        type_name: "V20GateReportV1",
        enum_names: &["V20GateOverallStatus"],
    },
    ArtifactSpec {
    ...
    fn generated_artifact_order_is_deterministic() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "canonical_closure_continuity_authority_v1",
                ...
                "canonical_seal_continuity_authority_v1",
                ...
                "primary_semantics_closure_sweep_v1",
