...
mod governance_lock_sweep;
mod governance_residual_sweep;
mod governance_seal_sweep;
...
mod primary_semantics_seal_sweep;
...
mod readiness_closure_sweep;
mod readiness_convergence_sweep;
mod readiness_final_consolidation_sweep;
mod readiness_lock_sweep;
mod readiness_residual_sweep;
mod readiness_seal_sweep;
mod readiness_spine;
...
pub use bundle_closure_sweep::{
    bundle_closure_sweep, BundleClosureConsumerStatusV1, BundleClosureMismatchCategoryV1,
    BundleClosureStatusV1, BundleClosureSweepReportV1, BundleClosureSweepV1,
};
...
pub use bundle_final_consolidation_sweep::{
    bundle_final_consolidation_sweep, BundleFinalConsolidationConsumerStatusV1,
    BundleFinalConsolidationMismatchCategoryV1, BundleFinalConsolidationStatusV1,
    BundleFinalConsolidationSweepReportV1, BundleFinalConsolidationSweepV1,
};
...
pub use bundle_stabilization_sweep::{
    ...
    BundleStabilizationMismatchCategoryV1, BundleStabilizationStatusV1,
    BundleStabilizationSweepReportV1, BundleStabilizationSweepV1,
};
pub use bundle_terminal_sweep::{
    bundle_terminal_sweep, AbsoluteFinalBundleTerminalSweepStatusV1,
    AbsoluteFinalBundleTerminalSweepV1, BundleTerminalConsumerStatusV1,
    BundleTerminalMismatchCategoryV1, BundleTerminalSweepReportV1,
};
pub use bundle_ultimate_sweep::{
...
pub use canonical_final_consolidation_continuity_sweep::{
    canonical_final_consolidation_continuity_sweep,
    CanonicalFinalConsolidationContinuityAuthorityV1,
    CanonicalFinalConsolidationContinuityStatusV1,
};
...
pub use final_governance_authority::{
    ...
    require_final_governance_inputs, require_governance_closure_inputs,
    require_governance_convergence_inputs, require_governance_final_consolidation_inputs,
    require_governance_lock_inputs, require_governance_seal_inputs,
    ...
    GovernanceClosureInputsV1, GovernanceConvergenceInputsV1, GovernanceFinalConsolidationInputsV1,
    GovernanceLockInputsV1, GovernanceSealInputsV1, GovernanceStabilizationInputsV1,
    ...
    FINAL_CONSOLIDATED_STABILIZED_CANONICAL_GOVERNANCE_INPUTS_REQUIRED,
    FINAL_GOVERNANCE_AUTHORITY_REQUIRED, FINAL_GOVERNANCE_INPUTS_REQUIRED,
    GOVERNANCE_ADAPTER_PATH_BLOCKED, GOVERNANCE_ADAPTER_PATH_REJECTED,
    GOVERNANCE_ADAPTER_PATH_TRANSLATED, GOVERNANCE_CACHE_PATH_BLOCKED,
    GOVERNANCE_CACHE_PATH_REJECTED, GOVERNANCE_CACHE_PATH_TRANSLATED, GOVERNANCE_ECHO_PATH_BLOCKED,
    GOVERNANCE_FACADE_PATH_BLOCKED, GOVERNANCE_FACADE_PATH_REJECTED,
    GOVERNANCE_FACADE_PATH_TRANSLATED, GOVERNANCE_FRAME_PATH_BLOCKED,
    GOVERNANCE_FRAME_PATH_REJECTED, GOVERNANCE_MEMO_PATH_BLOCKED, GOVERNANCE_MEMO_PATH_REJECTED,
    GOVERNANCE_MEMO_PATH_TRANSLATED, GOVERNANCE_SHELL_PATH_BLOCKED, GOVERNANCE_SHELL_PATH_REJECTED,
    GOVERNANCE_SHELL_PATH_TRANSLATED, GOVERNANCE_WRAPPER_PATH_BLOCKED,
    GOVERNANCE_WRAPPER_PATH_REJECTED, GOVERNANCE_WRAPPER_PATH_TRANSLATED,
...
pub use governance_closure_sweep::{
    governance_closure_sweep, GovernanceClosureConsumerStatusV1,
    GovernanceClosureMismatchCategoryV1, GovernanceClosureStatusV1, GovernanceClosureSweepReportV1,
    GovernanceClosureSweepV1,
};
pub use governance_convergence_sweep::{
    governance_convergence_sweep, GovernanceConvergenceConsumerStatusV1,
    GovernanceConvergenceMismatchCategoryV1, GovernanceConvergenceStatusV1,
    GovernanceConvergenceSweepReportV1, GovernanceConvergenceSweepV1,
};
...
pub use governance_lock_sweep::{
    governance_lock_sweep, GovernanceLockConsumerStatusV1, GovernanceLockMismatchCategoryV1,
    GovernanceLockStatusV1, GovernanceLockSweepReportV1, GovernanceLockSweepV1,
};
...
pub use governance_seal_sweep::{
    governance_seal_sweep, GovernanceSealConsumerStatusV1, GovernanceSealMismatchCategoryV1,
    GovernanceSealStatusV1, GovernanceSealSweepReportV1, GovernanceSealSweepV1,
};
...
pub use governance_ultimate_sweep::{
    governance_ultimate_sweep, GovernanceUltimateConsumerStatusV1,
    GovernanceUltimateMismatchCategoryV1, GovernanceUltimateSweepReportV1,
...
pub use models_lifecycle::{
    ...
    SupportedScopeExecutionV9, SupportedScopeExpansionDecisionReportV1,
    SupportedScopeExpansionDecisionStatusV1, SupportedScopeExpansionDecisionV1,
    SupportedScopeExpansionReasonCodeV1, SupportedScopeReevaluationDecisionV1,
...
pub use primary_semantics_final_consolidation_sweep::{
    primary_semantics_final_consolidation_sweep,
    PrimarySemanticsFinalConsolidationMismatchCategoryV1,
    PrimarySemanticsFinalConsolidationStatusV1, PrimarySemanticsFinalConsolidationSurfaceStatusV1,
    PrimarySemanticsFinalConsolidationSweepReportV1, PrimarySemanticsFinalConsolidationSweepV1,
};
...
pub use primary_semantics_seal_sweep::{
    primary_semantics_seal_sweep, PrimarySemanticsSealMismatchCategoryV1,
    PrimarySemanticsSealStatusV1, PrimarySemanticsSealSurfaceStatusV1,
    PrimarySemanticsSealSweepReportV1, PrimarySemanticsSealSweepV1,
};
...
pub use primary_semantics_ultimate_sweep::{
    primary_semantics_ultimate_sweep, PrimarySemanticsUltimateMismatchCategoryV1,
    PrimarySemanticsUltimateSurfaceStatusV1, PrimarySemanticsUltimateSweepReportV1,
    TerminalPrimarySemanticsUltimateSweepStatusV1, TerminalPrimarySemanticsUltimateSweepV1,
};
...
pub use readiness_closure_sweep::{
    readiness_closure_sweep, ReadinessClosureConsumerStatusV1, ReadinessClosureMismatchCategoryV1,
    ReadinessClosureStatusV1, ReadinessClosureSweepReportV1, ReadinessClosureSweepV1,
};
pub use readiness_convergence_sweep::{
    readiness_convergence_sweep, ReadinessConvergenceConsumerStatusV1,
    ReadinessConvergenceMismatchCategoryV1, ReadinessConvergenceStatusV1,
    ReadinessConvergenceSweepReportV1, ReadinessConvergenceSweepV1,
};
pub use readiness_final_consolidation_sweep::{
    readiness_final_consolidation_sweep, ReadinessFinalConsolidationConsumerStatusV1,
    ReadinessFinalConsolidationMismatchCategoryV1, ReadinessFinalConsolidationStatusV1,
    ReadinessFinalConsolidationSweepReportV1, ReadinessFinalConsolidationSweepV1,
};
pub use readiness_lock_sweep::{
    readiness_lock_sweep, ReadinessLockConsumerStatusV1, ReadinessLockMismatchCategoryV1,
    ReadinessLockStatusV1, ReadinessLockSweepReportV1, ReadinessLockSweepV1,
};
...
pub use readiness_seal_sweep::{
    readiness_seal_sweep, ReadinessSealConsumerStatusV1, ReadinessSealMismatchCategoryV1,
    ReadinessSealStatusV1, ReadinessSealSweepReportV1, ReadinessSealSweepV1,
};
pub use readiness_spine::{
    ...
    require_final_readiness_inputs, require_readiness_closure_inputs,
    require_readiness_convergence_inputs, require_readiness_final_consolidation_inputs,
    require_readiness_lock_inputs, require_readiness_seal_inputs,
    ...
    FinalReadinessInputsContextV1, ReadinessClosureInputsV1, ReadinessConvergenceInputsV1,
    ReadinessFinalConsolidationInputsV1, ReadinessLockInputsV1, ReadinessSealInputsV1,
    ...
    CANONICAL_EXECUTION_REALITY_REQUIRED, CANONICAL_READINESS_SPINE_REQUIRED,
    ...
    GOVERNANCE_LOCK_INPUTS_REQUIRED, HISTORICAL_READINESS_LINEAGE_BLOCKED,
    ...
    READINESS_ADAPTER_PATH_BLOCKED, READINESS_ADAPTER_PATH_REJECTED,
    READINESS_ADAPTER_PATH_TRANSLATED, READINESS_AUXILIARY_PATH_REJECTED,
    ...
    READINESS_FACADE_PATH_BLOCKED, READINESS_FACADE_PATH_REJECTED,
    READINESS_FACADE_PATH_TRANSLATED, READINESS_INFLATION_PATH_BLOCKED,
    READINESS_MEMO_PATH_BLOCKED, READINESS_MEMO_PATH_REJECTED, READINESS_MEMO_PATH_TRANSLATED,
    READINESS_SCOPE_OVERRUN, READINESS_SHELL_PATH_BLOCKED, READINESS_SHELL_PATH_REJECTED,
    READINESS_SHELL_PATH_TRANSLATED, READINESS_WRAPPER_PATH_BLOCKED,
    READINESS_WRAPPER_PATH_REJECTED, READINESS_WRAPPER_PATH_TRANSLATED,
    ...
    SLOT_REVIEWABILITY_TRUTH_REQUIRED, STABILIZED_CONVERGED_CANONICAL_READINESS_INPUTS_REQUIRED,
    SUPPORTED_SCOPE_DECISION_REQUIRED,
...
pub use readiness_terminal_sweep::{
    ...
    AbsoluteFinalReadinessTerminalSweepV1, ReadinessTerminalConsumerStatusV1,
    ReadinessTerminalMismatchCategoryV1, ReadinessTerminalSweepReportV1,
};
pub use readiness_ultimate_sweep::{
    readiness_ultimate_sweep, ReadinessUltimateConsumerStatusV1,
    ReadinessUltimateMismatchCategoryV1, ReadinessUltimateSweepReportV1,
    TerminalReadinessUltimateSweepStatusV1, TerminalReadinessUltimateSweepV1,
};
...
pub use remediation_consistency::{
    ...
    require_primary_semantics_final_consolidation_inputs, require_primary_semantics_seal_inputs,
    ...
    PrimarySemanticsObservedSurfaceV1, PrimarySemanticsSealInputsV1,
    ...
    PRIMARY_SEMANTICS_MEMO_PATH_TRANSLATED, PRIMARY_SEMANTICS_SHELL_PATH_BLOCKED,
    PRIMARY_SEMANTICS_SHELL_PATH_REJECTED, PRIMARY_SEMANTICS_SHELL_PATH_TRANSLATED,
    PRIMARY_SEMANTICS_WRAPPER_PATH_BLOCKED, PRIMARY_SEMANTICS_WRAPPER_PATH_REJECTED,
    PRIMARY_SEMANTICS_WRAPPER_PATH_TRANSLATED,
...
pub use residual_free_bundle_sweep::{
    ...
    ResidualFreeBundleConsumerAuthorityV1, ResidualFreeBundleConsumerStatusV1,
    ResidualFreeBundleMismatchCategoryV1, ResidualFreeBundleSweepReportV1,
};
...
pub use v14_gate::{v14_gate, V14GateCheckV1, V14GateOverallStatus, V14GateReportV1};
...
pub use v19_gate::{v19_gate, V19GateCheckV1, V19GateOverallStatus, V19GateReportV1};
pub use v20_gate::{v20_gate, V20GateCheckV1, V20GateOverallStatus, V20GateReportV1};
...
pub struct ReproPackManifestV1 {
    ...
    #[serde(default = "missing_prefix_value")]
    pub bundle_residual_sweep_digest_prefix: String,
    #[serde(default = "missing_prefix_value")]
    pub residual_free_bundle_consumer_authority_digest_prefix: String,
    #[serde(default = "missing_prefix_value")]
    pub bundle_absolute_sweep_digest_prefix: String,
    #[serde(default = "missing_prefix_value")]
...
pub const CONVERGED_CANONICAL_BUNDLE_INPUTS_REQUIRED: &str =
    "CONVERGED_CANONICAL_BUNDLE_INPUTS_REQUIRED";
...
pub const FINAL_BUNDLE_INPUTS_REQUIRED: &str = "FINAL_BUNDLE_INPUTS_REQUIRED";
pub const RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED: &str =
    "RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED";
pub const HISTORICAL_BUNDLE_PATH_BLOCKED: &str = "HISTORICAL_BUNDLE_PATH_BLOCKED";
pub const HISTORICAL_BUNDLE_LINEAGE_BLOCKED: &str = "HISTORICAL_BUNDLE_LINEAGE_BLOCKED";
pub const HISTORICAL_BUNDLE_LINEAGE_TRANSLATED: &str = "HISTORICAL_BUNDLE_LINEAGE_TRANSLATED";
pub const HISTORICAL_BUNDLE_LINEAGE_REJECTED: &str = "HISTORICAL_BUNDLE_LINEAGE_REJECTED";
pub const RESIDUAL_BUNDLE_PATH_BLOCKED: &str = "RESIDUAL_BUNDLE_PATH_BLOCKED";
pub const RESIDUAL_BUNDLE_PATH_TRANSLATED: &str = "RESIDUAL_BUNDLE_PATH_TRANSLATED";
pub const RESIDUAL_BUNDLE_PATH_REJECTED: &str = "RESIDUAL_BUNDLE_PATH_REJECTED";
pub const ABSOLUTE_RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED: &str =
    "ABSOLUTE_RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED";
pub const BUNDLE_ECHO_PATH_BLOCKED: &str = "BUNDLE_ECHO_PATH_BLOCKED";
pub const BUNDLE_ECHO_PATH_TRANSLATED: &str = "BUNDLE_ECHO_PATH_TRANSLATED";
pub const BUNDLE_ECHO_PATH_REJECTED: &str = "BUNDLE_ECHO_PATH_REJECTED";
pub const TERMINAL_ABSOLUTE_RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED: &str =
    "TERMINAL_ABSOLUTE_RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED";
...
pub const BUNDLE_ADAPTER_PATH_BLOCKED: &str = "BUNDLE_ADAPTER_PATH_BLOCKED";
pub const BUNDLE_ADAPTER_PATH_TRANSLATED: &str = "BUNDLE_ADAPTER_PATH_TRANSLATED";
pub const BUNDLE_ADAPTER_PATH_REJECTED: &str = "BUNDLE_ADAPTER_PATH_REJECTED";
pub const STABILIZED_CONVERGED_CANONICAL_BUNDLE_INPUTS_REQUIRED: &str =
    "STABILIZED_CONVERGED_CANONICAL_BUNDLE_INPUTS_REQUIRED";
pub const FINAL_CONSOLIDATED_STABILIZED_CANONICAL_BUNDLE_INPUTS_REQUIRED: &str =
    "FINAL_CONSOLIDATED_STABILIZED_CANONICAL_BUNDLE_INPUTS_REQUIRED";
pub const BUNDLE_FACADE_PATH_BLOCKED: &str = "BUNDLE_FACADE_PATH_BLOCKED";
pub const BUNDLE_FACADE_PATH_TRANSLATED: &str = "BUNDLE_FACADE_PATH_TRANSLATED";
pub const BUNDLE_FACADE_PATH_REJECTED: &str = "BUNDLE_FACADE_PATH_REJECTED";
...
pub(crate) fn parse_normalized_bundle_manifest(
...
struct BundleRoundTripInputs<'a> {
    ...
    final_bundle_consumer_authority_digest_prefix: &'a str,
    bundle_residual_sweep_digest_prefix: &'a str,
    residual_free_bundle_consumer_authority_digest_prefix: &'a str,
    bundle_absolute_sweep_digest_prefix: &'a str,
    bundle_terminal_sweep_digest_prefix: &'a str,
    bundle_ultimate_sweep_digest_prefix: &'a str,
    bundle_convergence_sweep_digest_prefix: &'a str,
...
fn evaluate_bundle_spine(
    ...
    Ok(BundleSpineCheckReportV1 {
        ...
        final_bundle_consumer_authority_digest_prefix: input
            .roundtrip
            .final_bundle_consumer_authority_digest_prefix
            .clone(),
        bundle_residual_sweep_digest_prefix: input
            .roundtrip
            .bundle_residual_sweep_digest_prefix
            .clone(),
        residual_free_bundle_consumer_authority_digest_prefix: input
            .roundtrip
            .residual_free_bundle_consumer_authority_digest_prefix
            .clone(),
        bundle_absolute_sweep_digest_prefix: input
            .roundtrip
            .bundle_absolute_sweep_digest_prefix
            .clone(),
        bundle_terminal_sweep_digest_prefix: input
            .roundtrip
            .bundle_terminal_sweep_digest_prefix
            .clone(),
        bundle_ultimate_sweep_digest_prefix: input
            .roundtrip
...
pub struct FinalBundleInputsV1 {
    pub export_context: CanonicalExportContextV1,
    pub bundle_consumption_context: CanonicalBundleConsumptionContextV1,
    pub bundle_spine: CanonicalBundleSpineV1,
    pub bundle_authority: CanonicalBundleAuthorityV2,
    pub final_bundle_consumer_authority: crate::FinalBundleConsumerAuthorityV1,
    pub final_bundle_authority_context: FinalBundleAuthorityContextV1,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ResidualFreeFinalBundleInputsV1 {
    pub applied_supported_set_digest_prefix: String,
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct ResidualFreeBundleAbsoluteInputsV1 {
    pub applied_supported_set_digest_prefix: String,
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct AbsoluteFinalBundleTerminalInputsV1 {
    pub applied_supported_set_digest_prefix: String,
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct TerminalBundleUltimateInputsV1 {
    pub applied_supported_set_digest_prefix: String,
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct BundleStabilizationInputsV1 {
    pub applied_supported_set_digest_prefix: String,
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct BundleFinalConsolidationInputsV1 {
    pub applied_supported_set_digest_prefix: String,
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct BundleClosureInputsV1 {
    pub applied_supported_set_digest_prefix: String,
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_readiness_spine_digest_prefix: String,
    pub canonical_bundle_spine_digest_prefix: String,
...
pub fn require_final_bundle_inputs(
    bundle_kind: CanonicalBundleKindV1,
    ...
    governance: Option<&CanonicalGovernanceEntryV1>,
    readiness: Option<&CanonicalReadinessSpineV1>,
) -> Result<FinalBundleInputsV1, OpsError> {
    let (Some(export_context), Some(related_artifacts), Some(bundle_consumption_context)) = (
        export_context,
        related_artifacts,
        bundle_consumption_context,
    ) else {
        return Err(OpsError::Invalid(FINAL_BUNDLE_INPUTS_REQUIRED.to_string()));
    };
    if export_context.context_digest.is_empty() {
        return Err(OpsError::Invalid(
            CANONICAL_EXPORT_CONTEXT_REQUIRED.to_string(),
        ));
    }
    ...
    let derived_context =
        parse_normalized_bundle_manifest(bundle_kind, export_context, related_artifacts)?;
    if bundle_consumption_context != &derived_context {
        return Err(OpsError::Invalid(RESIDUAL_BUNDLE_PATH_REJECTED.to_string()));
    }
    let final_bundle_authority_context = require_final_bundle_authority(
        applied,
        governance,
        readiness,
        bundle_spine,
    ...
    .map_err(|_| OpsError::Invalid(FINAL_BUNDLE_INPUTS_REQUIRED.to_string()))?;

    let Some(final_bundle_consumer_authority) = final_bundle_consumer_authority else {
        return Err(OpsError::Invalid(FINAL_BUNDLE_INPUTS_REQUIRED.to_string()));
    };
    if !matches!(
        final_bundle_consumer_authority.authority_status,
        crate::FinalBundleConsumerAuthorityStatusV1::Pass
    ) {
        return Err(OpsError::Invalid(RESIDUAL_BUNDLE_PATH_BLOCKED.to_string()));
    }
    if final_bundle_consumer_authority.applied_supported_set_digest_prefix
        != final_bundle_authority_context.applied_supported_set_digest_prefix
        || final_bundle_consumer_authority.canonical_governance_entry_digest_prefix
            != final_bundle_authority_context.canonical_governance_entry_digest_prefix
        || final_bundle_consumer_authority.canonical_readiness_spine_digest_prefix
            != final_bundle_authority_context.canonical_readiness_spine_digest_prefix
        || final_bundle_consumer_authority.canonical_bundle_spine_digest_prefix
            != final_bundle_authority_context.canonical_bundle_spine_digest_prefix
        || final_bundle_consumer_authority.canonical_bundle_authority_digest_prefix
            != final_bundle_authority_context.canonical_bundle_authority_digest_prefix
    {
        return Err(OpsError::Invalid(RESIDUAL_BUNDLE_PATH_BLOCKED.to_string()));
    }

    Ok(FinalBundleInputsV1 {
        export_context: export_context.clone(),
        bundle_consumption_context: derived_context,
        bundle_spine: bundle_spine
            .cloned()
            .ok_or_else(|| OpsError::Invalid(CANONICAL_BUNDLE_SPINE_REQUIRED.to_string()))?,
        bundle_authority: bundle_authority
            .cloned()
            .ok_or_else(|| OpsError::Invalid(FINAL_BUNDLE_AUTHORITY_REQUIRED.to_string()))?,
        final_bundle_consumer_authority: final_bundle_consumer_authority.clone(),
        final_bundle_authority_context,
    })
}

#[allow(clippy::too_many_arguments)]
pub fn require_residual_free_final_bundle_inputs(
    bundle_kind: CanonicalBundleKindV1,
    export_context: Option<&CanonicalExportContextV1>,
    related_artifacts: Option<&[CanonicalExportArtifactRefV1]>,
    bundle_consumption_context: Option<&CanonicalBundleConsumptionContextV1>,
    ...
    governance: Option<&CanonicalGovernanceEntryV1>,
    readiness: Option<&CanonicalReadinessSpineV1>,
) -> Result<ResidualFreeFinalBundleInputsV1, OpsError> {
    let inputs = require_final_bundle_inputs(
        bundle_kind,
        export_context,
        related_artifacts,
        bundle_consumption_context,
    ...
    .map_err(|_| OpsError::Invalid(RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED.to_string()))?;
    let Some(final_bundle_residual_sweep) = final_bundle_residual_sweep else {
        return Err(OpsError::Invalid(
            RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED.to_string(),
        ));
    };
    if !matches!(
        final_bundle_residual_sweep.sweep_status,
        crate::FinalBundleResidualSweepStatusV1::Pass
    ) {
        return Err(OpsError::Invalid(
            HISTORICAL_BUNDLE_PATH_BLOCKED.to_string(),
        ));
    }
    if final_bundle_residual_sweep.applied_supported_set_digest_prefix
        != inputs
            .final_bundle_authority_context
            .applied_supported_set_digest_prefix
        || final_bundle_residual_sweep.canonical_governance_entry_digest_prefix
            != inputs
                .final_bundle_authority_context
                .canonical_governance_entry_digest_prefix
        || final_bundle_residual_sweep.canonical_readiness_spine_digest_prefix
            != inputs
                .final_bundle_authority_context
                .canonical_readiness_spine_digest_prefix
        || final_bundle_residual_sweep.canonical_bundle_spine_digest_prefix
            != inputs
                .final_bundle_authority_context
                .canonical_bundle_spine_digest_prefix
        || final_bundle_residual_sweep.canonical_bundle_authority_digest_prefix
            != inputs
                .final_bundle_authority_context
                .canonical_bundle_authority_digest_prefix
        || final_bundle_residual_sweep.final_bundle_consumer_authority_digest_prefix
            != prefix_hex(&inputs.final_bundle_consumer_authority.authority_digest, 16)
    {
        return Err(OpsError::Invalid(
            HISTORICAL_BUNDLE_PATH_BLOCKED.to_string(),
        ));
    ...
    digest_source.extend_from_slice(b"residual_free_final_bundle_inputs_v1");
    ...
    digest_source.extend_from_slice(
        prefix_hex(&inputs.final_bundle_consumer_authority.authority_digest, 16).as_bytes(),
    );
    digest_source
        .extend_from_slice(prefix_hex(&final_bundle_residual_sweep.sweep_digest, 16).as_bytes());
    Ok(ResidualFreeFinalBundleInputsV1 {
        applied_supported_set_digest_prefix: inputs
            .final_bundle_authority_context
            .applied_supported_set_digest_prefix,
        ...
        canonical_readiness_spine_digest_prefix: inputs
            .final_bundle_authority_context
            .canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: inputs
            .final_bundle_authority_context
            .canonical_bundle_spine_digest_prefix,
        canonical_bundle_authority_digest_prefix: inputs
            .final_bundle_authority_context
            .canonical_bundle_authority_digest_prefix,
        final_bundle_consumer_authority_digest_prefix: prefix_hex(
            &inputs.final_bundle_consumer_authority.authority_digest,
            16,
        ),
        final_bundle_residual_sweep_digest_prefix: prefix_hex(
            &final_bundle_residual_sweep.sweep_digest,
            16,
        ),
...
#[allow(clippy::too_many_arguments)]
pub fn require_residual_free_bundle_absolute_inputs(
    bundle_kind: CanonicalBundleKindV1,
    export_context: Option<&CanonicalExportContextV1>,
    related_artifacts: Option<&[CanonicalExportArtifactRefV1]>,
    bundle_consumption_context: Option<&CanonicalBundleConsumptionContextV1>,
    ...
    governance: Option<&CanonicalGovernanceEntryV1>,
    readiness: Option<&CanonicalReadinessSpineV1>,
) -> Result<ResidualFreeBundleAbsoluteInputsV1, OpsError> {
    let base = require_residual_free_final_bundle_inputs(
        bundle_kind,
        export_context,
        related_artifacts,
        bundle_consumption_context,
    ...
    let Some(residual_free_bundle_consumer_authority) = residual_free_bundle_consumer_authority
    else {
        return Err(OpsError::Invalid(
            RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED.to_string(),
        ));
    };
    let expected_residual_free_prefix = prefix_hex(
        &residual_free_bundle_consumer_authority.authority_digest,
        16,
    );
    if !matches!(
        residual_free_bundle_consumer_authority.authority_status,
        crate::ResidualFreeBundleConsumerAuthorityStatusV1::Pass
    ) || residual_free_bundle_consumer_authority.applied_supported_set_digest_prefix
        != base.applied_supported_set_digest_prefix
        || residual_free_bundle_consumer_authority.canonical_governance_entry_digest_prefix
            != base.canonical_governance_entry_digest_prefix
        || residual_free_bundle_consumer_authority.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || residual_free_bundle_consumer_authority.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || residual_free_bundle_consumer_authority.canonical_bundle_authority_digest_prefix
            != base.canonical_bundle_authority_digest_prefix
        || residual_free_bundle_consumer_authority.final_bundle_consumer_authority_digest_prefix
            != base.final_bundle_consumer_authority_digest_prefix
        || residual_free_bundle_consumer_authority.final_bundle_residual_sweep_digest_prefix
            != base.final_bundle_residual_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(
            HISTORICAL_BUNDLE_LINEAGE_BLOCKED.to_string(),
        ));
    }

    let mut digest_source = Vec::new();
    digest_source.extend_from_slice(b"residual_free_bundle_absolute_inputs_v1");
    ...
    Ok(ResidualFreeBundleAbsoluteInputsV1 {
        ...
        residual_free_bundle_consumer_authority_digest_prefix: expected_residual_free_prefix,
        authority_digest: sha256_hex(&digest_source),
    })
}

#[allow(clippy::too_many_arguments)]
pub fn require_absolute_final_bundle_terminal_inputs(
    bundle_kind: CanonicalBundleKindV1,
    export_context: Option<&CanonicalExportContextV1>,
    related_artifacts: Option<&[CanonicalExportArtifactRefV1]>,
    bundle_consumption_context: Option<&CanonicalBundleConsumptionContextV1>,
    ...
    governance: Option<&CanonicalGovernanceEntryV1>,
    readiness: Option<&CanonicalReadinessSpineV1>,
) -> Result<AbsoluteFinalBundleTerminalInputsV1, OpsError> {
    let base = require_residual_free_bundle_absolute_inputs(
        bundle_kind,
        export_context,
        related_artifacts,
        bundle_consumption_context,
    ...
    let Some(residual_free_bundle_absolute_sweep) = residual_free_bundle_absolute_sweep else {
        return Err(OpsError::Invalid(
            ABSOLUTE_RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED.to_string(),
        ));
    };
    let expected_absolute_prefix =
        prefix_hex(&residual_free_bundle_absolute_sweep.sweep_digest, 16);
    if !matches!(
        residual_free_bundle_absolute_sweep.sweep_status,
        crate::ResidualFreeBundleAbsoluteSweepStatusV1::Pass
    ) || residual_free_bundle_absolute_sweep.applied_supported_set_digest_prefix
        != base.applied_supported_set_digest_prefix
        || residual_free_bundle_absolute_sweep.canonical_governance_entry_digest_prefix
            != base.canonical_governance_entry_digest_prefix
        || residual_free_bundle_absolute_sweep.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || residual_free_bundle_absolute_sweep.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || residual_free_bundle_absolute_sweep.canonical_bundle_authority_digest_prefix
            != base.canonical_bundle_authority_digest_prefix
        || residual_free_bundle_absolute_sweep.final_bundle_consumer_authority_digest_prefix
            != base.final_bundle_consumer_authority_digest_prefix
        || residual_free_bundle_absolute_sweep.final_bundle_residual_sweep_digest_prefix
            != base.final_bundle_residual_sweep_digest_prefix
        || residual_free_bundle_absolute_sweep.residual_free_bundle_consumer_authority_digest_prefix
            != base.residual_free_bundle_consumer_authority_digest_prefix
    {
        return Err(OpsError::Invalid(BUNDLE_ECHO_PATH_BLOCKED.to_string()));
    }

    let mut digest_source = Vec::new();
    digest_source.extend_from_slice(b"absolute_final_bundle_terminal_inputs_v1");
    digest_source.extend_from_slice(base.applied_supported_set_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_governance_entry_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_readiness_spine_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_bundle_spine_digest_prefix.as_bytes());
    ...
    Ok(AbsoluteFinalBundleTerminalInputsV1 {
        applied_supported_set_digest_prefix: base.applied_supported_set_digest_prefix,
        canonical_governance_entry_digest_prefix: base.canonical_governance_entry_digest_prefix,
        canonical_readiness_spine_digest_prefix: base.canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: base.canonical_bundle_spine_digest_prefix,
        ...
        residual_free_bundle_consumer_authority_digest_prefix: base
            .residual_free_bundle_consumer_authority_digest_prefix,
        residual_free_bundle_absolute_sweep_digest_prefix: expected_absolute_prefix,
        authority_digest: sha256_hex(&digest_source),
    })
}

#[allow(clippy::too_many_arguments)]
pub fn require_terminal_bundle_ultimate_inputs(
    bundle_kind: CanonicalBundleKindV1,
    export_context: Option<&CanonicalExportContextV1>,
    related_artifacts: Option<&[CanonicalExportArtifactRefV1]>,
    bundle_consumption_context: Option<&CanonicalBundleConsumptionContextV1>,
    ...
    governance: Option<&CanonicalGovernanceEntryV1>,
    readiness: Option<&CanonicalReadinessSpineV1>,
) -> Result<TerminalBundleUltimateInputsV1, OpsError> {
    let base = require_absolute_final_bundle_terminal_inputs(
        bundle_kind,
        export_context,
        related_artifacts,
        bundle_consumption_context,
    ...
    .map_err(|_| {
        OpsError::Invalid(TERMINAL_ABSOLUTE_RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED.to_string())
    })?;
    let Some(absolute_final_bundle_terminal_sweep) = absolute_final_bundle_terminal_sweep else {
        return Err(OpsError::Invalid(
            TERMINAL_ABSOLUTE_RESIDUAL_FREE_FINAL_BUNDLE_INPUTS_REQUIRED.to_string(),
        ));
    };
    let expected_terminal_prefix =
        prefix_hex(&absolute_final_bundle_terminal_sweep.sweep_digest, 16);
    if !matches!(
        absolute_final_bundle_terminal_sweep.sweep_status,
        crate::AbsoluteFinalBundleTerminalSweepStatusV1::Pass
    ) || absolute_final_bundle_terminal_sweep.applied_supported_set_digest_prefix
        != base.applied_supported_set_digest_prefix
        || absolute_final_bundle_terminal_sweep.canonical_governance_entry_digest_prefix
            != base.canonical_governance_entry_digest_prefix
        || absolute_final_bundle_terminal_sweep.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || absolute_final_bundle_terminal_sweep.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || absolute_final_bundle_terminal_sweep.canonical_bundle_authority_digest_prefix
            != base.canonical_bundle_authority_digest_prefix
        || absolute_final_bundle_terminal_sweep.final_bundle_consumer_authority_digest_prefix
            != base.final_bundle_consumer_authority_digest_prefix
        || absolute_final_bundle_terminal_sweep.final_bundle_residual_sweep_digest_prefix
            != base.final_bundle_residual_sweep_digest_prefix
        || absolute_final_bundle_terminal_sweep
            .residual_free_bundle_consumer_authority_digest_prefix
            != base.residual_free_bundle_consumer_authority_digest_prefix
        || absolute_final_bundle_terminal_sweep.residual_free_bundle_absolute_sweep_digest_prefix
            != base.residual_free_bundle_absolute_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(BUNDLE_CACHE_PATH_BLOCKED.to_string()));
    }

    let mut digest_source = Vec::new();
    digest_source.extend_from_slice(b"terminal_bundle_ultimate_inputs_v1");
    digest_source.extend_from_slice(base.applied_supported_set_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_governance_entry_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_readiness_spine_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_bundle_spine_digest_prefix.as_bytes());
    ...
    digest_source.extend_from_slice(expected_terminal_prefix.as_bytes());

    Ok(TerminalBundleUltimateInputsV1 {
        applied_supported_set_digest_prefix: base.applied_supported_set_digest_prefix,
        canonical_governance_entry_digest_prefix: base.canonical_governance_entry_digest_prefix,
        canonical_readiness_spine_digest_prefix: base.canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: base.canonical_bundle_spine_digest_prefix,
...
#[allow(clippy::too_many_arguments)]
pub fn require_bundle_stabilization_inputs(
    bundle_kind: CanonicalBundleKindV1,
    export_context: Option<&CanonicalExportContextV1>,
    related_artifacts: Option<&[CanonicalExportArtifactRefV1]>,
    bundle_consumption_context: Option<&CanonicalBundleConsumptionContextV1>,
    ...
    governance: Option<&CanonicalGovernanceEntryV1>,
    readiness: Option<&CanonicalReadinessSpineV1>,
) -> Result<BundleStabilizationInputsV1, OpsError> {
    let base = require_bundle_convergence_inputs(
        bundle_kind,
        export_context,
        related_artifacts,
        bundle_consumption_context,
    ...
    .map_err(|_| OpsError::Invalid(CONVERGED_CANONICAL_BUNDLE_INPUTS_REQUIRED.to_string()))?;

    let Some(bundle_convergence_sweep) = bundle_convergence_sweep else {
        return Err(OpsError::Invalid(
            CONVERGED_CANONICAL_BUNDLE_INPUTS_REQUIRED.to_string(),
        ));
    };
    let expected_convergence_prefix = prefix_hex(&bundle_convergence_sweep.convergence_digest, 16);
    if !matches!(
        bundle_convergence_sweep.convergence_status,
        crate::BundleConvergenceStatusV1::Pass
    ) || bundle_convergence_sweep.applied_supported_set_digest_prefix
        != base.applied_supported_set_digest_prefix
        || bundle_convergence_sweep.canonical_governance_entry_digest_prefix
            != base.canonical_governance_entry_digest_prefix
        || bundle_convergence_sweep.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || bundle_convergence_sweep.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || bundle_convergence_sweep.canonical_bundle_authority_digest_prefix
            != base.canonical_bundle_authority_digest_prefix
        || bundle_convergence_sweep.final_bundle_consumer_authority_digest_prefix
            != base.final_bundle_consumer_authority_digest_prefix
        || bundle_convergence_sweep.final_bundle_residual_sweep_digest_prefix
            != base.final_bundle_residual_sweep_digest_prefix
        || bundle_convergence_sweep.residual_free_bundle_consumer_authority_digest_prefix
            != base.residual_free_bundle_consumer_authority_digest_prefix
        || bundle_convergence_sweep.residual_free_bundle_absolute_sweep_digest_prefix
            != base.residual_free_bundle_absolute_sweep_digest_prefix
        || bundle_convergence_sweep.absolute_final_bundle_terminal_sweep_digest_prefix
            != base.absolute_final_bundle_terminal_sweep_digest_prefix
        || bundle_convergence_sweep.terminal_bundle_ultimate_sweep_digest_prefix
            != base.terminal_bundle_ultimate_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(BUNDLE_ADAPTER_PATH_BLOCKED.to_string()));
    }

    let mut digest_source = Vec::new();
    digest_source.extend_from_slice(b"bundle_stabilization_inputs_v1");
    digest_source.extend_from_slice(base.applied_supported_set_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_governance_entry_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_readiness_spine_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_bundle_spine_digest_prefix.as_bytes());
    ...
    digest_source.extend_from_slice(expected_convergence_prefix.as_bytes());

    Ok(BundleStabilizationInputsV1 {
        applied_supported_set_digest_prefix: base.applied_supported_set_digest_prefix,
        canonical_governance_entry_digest_prefix: base.canonical_governance_entry_digest_prefix,
        canonical_readiness_spine_digest_prefix: base.canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: base.canonical_bundle_spine_digest_prefix,
        ...
        bundle_convergence_sweep_digest_prefix: expected_convergence_prefix,
        authority_digest: sha256_hex(&digest_source),
    })
}

#[allow(clippy::too_many_arguments)]
pub fn require_bundle_final_consolidation_inputs(
    bundle_kind: CanonicalBundleKindV1,
    export_context: Option<&CanonicalExportContextV1>,
    related_artifacts: Option<&[CanonicalExportArtifactRefV1]>,
    bundle_consumption_context: Option<&CanonicalBundleConsumptionContextV1>,
    ...
    governance: Option<&CanonicalGovernanceEntryV1>,
    readiness: Option<&CanonicalReadinessSpineV1>,
) -> Result<BundleFinalConsolidationInputsV1, OpsError> {
    let base = require_bundle_stabilization_inputs(
        bundle_kind,
        export_context,
        related_artifacts,
        bundle_consumption_context,
    ...
    .map_err(|_| {
        OpsError::Invalid(STABILIZED_CONVERGED_CANONICAL_BUNDLE_INPUTS_REQUIRED.to_string())
    })?;

    let Some(bundle_stabilization_sweep) = bundle_stabilization_sweep else {
        return Err(OpsError::Invalid(
            STABILIZED_CONVERGED_CANONICAL_BUNDLE_INPUTS_REQUIRED.to_string(),
        ));
    };
    let expected_stabilization_prefix =
        prefix_hex(&bundle_stabilization_sweep.stabilization_digest, 16);
    if !matches!(
        bundle_stabilization_sweep.stabilization_status,
        crate::BundleStabilizationStatusV1::Pass
    ) || bundle_stabilization_sweep.applied_supported_set_digest_prefix
        != base.applied_supported_set_digest_prefix
        || bundle_stabilization_sweep.canonical_governance_entry_digest_prefix
            != base.canonical_governance_entry_digest_prefix
        || bundle_stabilization_sweep.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || bundle_stabilization_sweep.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || bundle_stabilization_sweep.canonical_bundle_authority_digest_prefix
            != base.canonical_bundle_authority_digest_prefix
        || bundle_stabilization_sweep.final_bundle_consumer_authority_digest_prefix
            != base.final_bundle_consumer_authority_digest_prefix
        || bundle_stabilization_sweep.final_bundle_residual_sweep_digest_prefix
            != base.final_bundle_residual_sweep_digest_prefix
        || bundle_stabilization_sweep.residual_free_bundle_consumer_authority_digest_prefix
            != base.residual_free_bundle_consumer_authority_digest_prefix
        || bundle_stabilization_sweep.residual_free_bundle_absolute_sweep_digest_prefix
            != base.residual_free_bundle_absolute_sweep_digest_prefix
        || bundle_stabilization_sweep.absolute_final_bundle_terminal_sweep_digest_prefix
            != base.absolute_final_bundle_terminal_sweep_digest_prefix
        || bundle_stabilization_sweep.terminal_bundle_ultimate_sweep_digest_prefix
            != base.terminal_bundle_ultimate_sweep_digest_prefix
        || bundle_stabilization_sweep.bundle_convergence_sweep_digest_prefix
            != base.bundle_convergence_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(BUNDLE_FACADE_PATH_BLOCKED.to_string()));
    }

    let mut digest_source = Vec::new();
    digest_source.extend_from_slice(b"bundle_final_consolidation_inputs_v1");
    digest_source.extend_from_slice(base.applied_supported_set_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_governance_entry_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_readiness_spine_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_bundle_spine_digest_prefix.as_bytes());
    ...
    digest_source.extend_from_slice(expected_stabilization_prefix.as_bytes());

    Ok(BundleFinalConsolidationInputsV1 {
        applied_supported_set_digest_prefix: base.applied_supported_set_digest_prefix,
        canonical_governance_entry_digest_prefix: base.canonical_governance_entry_digest_prefix,
        canonical_readiness_spine_digest_prefix: base.canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: base.canonical_bundle_spine_digest_prefix,
        ...
        bundle_stabilization_sweep_digest_prefix: expected_stabilization_prefix,
        authority_digest: sha256_hex(&digest_source),
    })
}

#[allow(clippy::too_many_arguments)]
pub fn require_bundle_closure_inputs(
    bundle_kind: CanonicalBundleKindV1,
    export_context: Option<&CanonicalExportContextV1>,
    related_artifacts: Option<&[CanonicalExportArtifactRefV1]>,
    bundle_consumption_context: Option<&CanonicalBundleConsumptionContextV1>,
    ...
    governance: Option<&CanonicalGovernanceEntryV1>,
    readiness: Option<&CanonicalReadinessSpineV1>,
) -> Result<BundleClosureInputsV1, OpsError> {
    let base = require_bundle_final_consolidation_inputs(
        bundle_kind,
        export_context,
        related_artifacts,
        bundle_consumption_context,
    ...
    .map_err(|_| {
        OpsError::Invalid(
            FINAL_CONSOLIDATED_STABILIZED_CANONICAL_BUNDLE_INPUTS_REQUIRED.to_string(),
        )
    })?;
    let Some(bundle_final_consolidation_sweep) = bundle_final_consolidation_sweep else {
        return Err(OpsError::Invalid(
            FINAL_CONSOLIDATED_STABILIZED_CANONICAL_BUNDLE_INPUTS_REQUIRED.to_string(),
        ));
    };
    let expected_consolidation_prefix =
        prefix_hex(&bundle_final_consolidation_sweep.consolidation_digest, 16);
    if !matches!(
        bundle_final_consolidation_sweep.consolidation_status,
        crate::BundleFinalConsolidationStatusV1::Pass
    ) || bundle_final_consolidation_sweep.applied_supported_set_digest_prefix
        != base.applied_supported_set_digest_prefix
        || bundle_final_consolidation_sweep.canonical_governance_entry_digest_prefix
            != base.canonical_governance_entry_digest_prefix
        || bundle_final_consolidation_sweep.canonical_readiness_spine_digest_prefix
            != base.canonical_readiness_spine_digest_prefix
        || bundle_final_consolidation_sweep.canonical_bundle_spine_digest_prefix
            != base.canonical_bundle_spine_digest_prefix
        || bundle_final_consolidation_sweep.canonical_bundle_authority_digest_prefix
            != base.canonical_bundle_authority_digest_prefix
        || bundle_final_consolidation_sweep.final_bundle_consumer_authority_digest_prefix
            != base.final_bundle_consumer_authority_digest_prefix
        || bundle_final_consolidation_sweep.final_bundle_residual_sweep_digest_prefix
            != base.final_bundle_residual_sweep_digest_prefix
        || bundle_final_consolidation_sweep.residual_free_bundle_consumer_authority_digest_prefix
            != base.residual_free_bundle_consumer_authority_digest_prefix
        || bundle_final_consolidation_sweep.residual_free_bundle_absolute_sweep_digest_prefix
            != base.residual_free_bundle_absolute_sweep_digest_prefix
        || bundle_final_consolidation_sweep.absolute_final_bundle_terminal_sweep_digest_prefix
            != base.absolute_final_bundle_terminal_sweep_digest_prefix
        || bundle_final_consolidation_sweep.terminal_bundle_ultimate_sweep_digest_prefix
            != base.terminal_bundle_ultimate_sweep_digest_prefix
        || bundle_final_consolidation_sweep.bundle_convergence_sweep_digest_prefix
            != base.bundle_convergence_sweep_digest_prefix
        || bundle_final_consolidation_sweep.bundle_stabilization_sweep_digest_prefix
            != base.bundle_stabilization_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(BUNDLE_WRAPPER_PATH_BLOCKED.to_string()));
    }

    let mut digest_source = Vec::new();
    digest_source.extend_from_slice(b"bundle_closure_inputs_v1");
    digest_source.extend_from_slice(base.applied_supported_set_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_governance_entry_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_readiness_spine_digest_prefix.as_bytes());
    digest_source.extend_from_slice(base.canonical_bundle_spine_digest_prefix.as_bytes());
    ...
    digest_source.extend_from_slice(expected_consolidation_prefix.as_bytes());

    Ok(BundleClosureInputsV1 {
        applied_supported_set_digest_prefix: base.applied_supported_set_digest_prefix,
        canonical_governance_entry_digest_prefix: base.canonical_governance_entry_digest_prefix,
        canonical_readiness_spine_digest_prefix: base.canonical_readiness_spine_digest_prefix,
        canonical_bundle_spine_digest_prefix: base.canonical_bundle_spine_digest_prefix,
        ...
        bundle_final_consolidation_sweep_digest_prefix: expected_consolidation_prefix,
        authority_digest: sha256_hex(&digest_source),
    })
}
...
fn evaluate_bundle_roundtrip_consistency(
    ...
    let mut report = BundleRoundTripConsistencyV1 {
        ...
        final_bundle_consumer_authority_digest_prefix: canonical_prefix_or_missing(
            input.final_bundle_consumer_authority_digest_prefix,
        ),
        bundle_residual_sweep_digest_prefix: canonical_prefix_or_missing(
            input.bundle_residual_sweep_digest_prefix,
        ),
        residual_free_bundle_consumer_authority_digest_prefix: canonical_prefix_or_missing(
            input.residual_free_bundle_consumer_authority_digest_prefix,
        ),
        bundle_absolute_sweep_digest_prefix: canonical_prefix_or_missing(
            input.bundle_absolute_sweep_digest_prefix,
        ),
        bundle_terminal_sweep_digest_prefix: canonical_prefix_or_missing(
            input.bundle_terminal_sweep_digest_prefix,
        ),
        bundle_ultimate_sweep_digest_prefix: canonical_prefix_or_missing(
            input.bundle_ultimate_sweep_digest_prefix,
        ),
        bundle_convergence_sweep_digest_prefix: canonical_prefix_or_missing(
            input.bundle_convergence_sweep_digest_prefix,
        ),
        bundle_stabilization_sweep_digest_prefix: canonical_prefix_or_missing(
            input.bundle_stabilization_sweep_digest_prefix,
        ),
        bundle_final_consolidation_sweep_digest_prefix: canonical_prefix_or_missing(
            input.bundle_final_consolidation_sweep_digest_prefix,
        ),
...
pub fn exports_roundtrip_check(
    ...
    if has_repro {
        ...
        let report = evaluate_bundle_roundtrip_consistency(BundleRoundTripInputs {
            ...
            final_bundle_consumer_authority_digest_prefix: &manifest
                .final_bundle_consumer_authority_digest_prefix,
            bundle_residual_sweep_digest_prefix: &manifest.bundle_residual_sweep_digest_prefix,
            residual_free_bundle_consumer_authority_digest_prefix: &manifest
                .residual_free_bundle_consumer_authority_digest_prefix,
            bundle_absolute_sweep_digest_prefix: &manifest.bundle_absolute_sweep_digest_prefix,
            bundle_terminal_sweep_digest_prefix: &manifest.bundle_terminal_sweep_digest_prefix,
            bundle_ultimate_sweep_digest_prefix: &manifest.bundle_ultimate_sweep_digest_prefix,
            bundle_convergence_sweep_digest_prefix: &manifest
                .bundle_convergence_sweep_digest_prefix,
            bundle_stabilization_sweep_digest_prefix: &manifest
...
fn read_digest_prefix_from_output(workdir: &Path, rel_path: &str, field_path: &str) -> String {
...
pub fn bugkit_build(
    ...
    let mut manifest = BugKitManifestV1 {
        ...
        final_bundle_consumer_authority_digest_prefix: "MISSING".to_string(),
        bundle_residual_sweep_digest_prefix: "MISSING".to_string(),
    ...
    let roundtrip = evaluate_bundle_roundtrip_consistency(BundleRoundTripInputs {
        ...
        bundle_terminal_sweep_digest_prefix: &manifest.bundle_terminal_sweep_digest_prefix,
        bundle_ultimate_sweep_digest_prefix: &manifest.bundle_ultimate_sweep_digest_prefix,
        bundle_convergence_sweep_digest_prefix: &manifest.bundle_convergence_sweep_digest_prefix,
        bundle_stabilization_sweep_digest_prefix: &manifest
            .bundle_stabilization_sweep_digest_prefix,
        bundle_final_consolidation_sweep_digest_prefix: &manifest
            .bundle_final_consolidation_sweep_digest_prefix,
    ...
    manifest.final_bundle_consumer_authority_digest_prefix = read_digest_prefix_from_output(
        workdir,
        "out/final_bundle_consumer_sweep.json",
        "authority.authority_digest",
    );
    manifest.bundle_residual_sweep_digest_prefix = read_digest_prefix_from_output(
        workdir,
        "out/bundle_residual_sweep.json",
        "sweep.sweep_digest",
    );
    manifest.residual_free_bundle_consumer_authority_digest_prefix = read_digest_prefix_from_output(
        workdir,
        "out/residual_free_bundle_sweep.json",
        "authority.authority_digest",
    );
    manifest.bundle_absolute_sweep_digest_prefix = read_digest_prefix_from_output(
        workdir,
        "out/bundle_absolute_sweep.json",
        "sweep.sweep_digest",
    );
    manifest.bundle_terminal_sweep_digest_prefix = read_digest_prefix_from_output(
        workdir,
        "out/bundle_terminal_sweep.json",
        "sweep.sweep_digest",
    );
    manifest.bundle_ultimate_sweep_digest_prefix = read_digest_prefix_from_output(
        workdir,
        "out/bundle_ultimate_sweep.json",
        "sweep.sweep_digest",
    );
    manifest.bundle_convergence_sweep_digest_prefix = read_digest_prefix_from_output(
        workdir,
        "out/bundle_convergence_sweep.json",
        "sweep.convergence_digest",
    );
    manifest.bundle_stabilization_sweep_digest_prefix = read_digest_prefix_from_output(
        workdir,
        "out/bundle_stabilization_sweep.json",
        "sweep.stabilization_digest",
    );
    manifest.bundle_final_consolidation_sweep_digest_prefix = read_digest_prefix_from_output(
        workdir,
        "out/bundle_final_consolidation_sweep.json",
        "sweep.consolidation_digest",
    );
    manifest.bundle_closure_sweep_digest_prefix = read_digest_prefix_from_output(
        workdir,
...
pub fn repro_verify(pack: &Path, out: &Path) -> Result<ReproVerifyReport, OpsError> {
    ...
    let report = ReproVerifyReport {
        ...
        first_divergence,
        reasons,
        residual_free_bundle_absolute_sweep_digest_prefix: manifest
            .bundle_absolute_sweep_digest_prefix
            .clone(),
        bundle_terminal_sweep_digest_prefix: manifest.bundle_terminal_sweep_digest_prefix.clone(),
        bundle_ultimate_sweep_digest_prefix: manifest.bundle_ultimate_sweep_digest_prefix.clone(),
        bundle_convergence_sweep_digest_prefix: manifest
            .bundle_convergence_sweep_digest_prefix
            .clone(),
        bundle_stabilization_sweep_digest_prefix: manifest
...
pub struct PortabilityReportV1 {
    ...
    pub residual_free_governance_sweep_smoke: PortabilityCommandCheck,
    pub governance_absolute_sweep_smoke: PortabilityCommandCheck,
    pub governance_terminal_sweep_smoke: PortabilityCommandCheck,
    pub governance_ultimate_sweep_smoke: PortabilityCommandCheck,
    pub governance_convergence_sweep_smoke: PortabilityCommandCheck,
    pub governance_stabilization_sweep_smoke: PortabilityCommandCheck,
    pub supported_scope_execute_v8_smoke: PortabilityCommandCheck,
    pub supported_scope_execute_v9_smoke: PortabilityCommandCheck,
    ...
    pub readiness_absolute_sweep_smoke: PortabilityCommandCheck,
    pub readiness_terminal_sweep_smoke: PortabilityCommandCheck,
    ...
    pub bundle_absolute_sweep_smoke: PortabilityCommandCheck,
    pub bundle_terminal_sweep_smoke: PortabilityCommandCheck,
    ...
    pub primary_semantics_absolute_sweep_smoke: PortabilityCommandCheck,
    pub primary_semantics_terminal_sweep_smoke: PortabilityCommandCheck,
...
fn out_smoke_check_with_skip<T, F>(
    name: &str,
    out: &str,
    command: F,
    detail: impl FnOnce(&T) -> String,
    skip_if: impl FnOnce(&str) -> bool,
) -> PortabilityCommandCheck
where
    F: FnOnce(&Path) -> Result<T, OpsError>,
{
    ...
    match command(&out_path) {
        ...
        Err(err) => {
            ...
            PortabilityCommandCheck {
                ...
                detail: if should_skip {
                    format!("skip_optional_path: {msg}")
                } else {
                    msg
                },
                out: Some(out.to_string()),
...
pub fn portability_report(workdir: &Path, out: &Path) -> Result<PortabilityReportV1, OpsError> {
    ...
    let governance_absolute_sweep_smoke = out_smoke_check_with_skip(
        "governance_absolute_sweep_smoke",
        ...
        |out_path| {
            ...
            let residual_free_out = PathBuf::from("./out/residual_free_governance_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            final_governance_consumer_sweep(workdir, &final_governance_out)?;
            governance_residual_sweep(workdir, &residual_out)?;
            residual_free_governance_sweep(workdir, &residual_free_out)?;
            governance_absolute_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let governance_ultimate_sweep_smoke = out_smoke_check_with_skip(
        "governance_ultimate_sweep_smoke",
        ...
        |out_path| {
            ...
            let residual_out = PathBuf::from("./out/governance_residual_sweep.json");
            let residual_free_out = PathBuf::from("./out/residual_free_governance_sweep.json");
            let absolute_out = PathBuf::from("./out/governance_absolute_sweep.json");
            let terminal_out = PathBuf::from("./out/governance_terminal_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            governance_residual_sweep(workdir, &residual_out)?;
            residual_free_governance_sweep(workdir, &residual_free_out)?;
            governance_absolute_sweep(workdir, &absolute_out)?;
            governance_terminal_sweep(workdir, &terminal_out)?;
            governance_ultimate_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let governance_convergence_sweep_smoke = out_smoke_check_with_skip(
        "governance_convergence_sweep_smoke",
        "./out/governance_convergence_sweep.json",
        |out_path| {
            let review_out = PathBuf::from("./out/supported_set_review.json");
            let reeval_out = PathBuf::from("./out/supported_scope_reeval.json");
            let apply_out = PathBuf::from("./out/supported_set_apply.json");
            ...
            let absolute_out = PathBuf::from("./out/governance_absolute_sweep.json");
            let terminal_out = PathBuf::from("./out/governance_terminal_sweep.json");
            let ultimate_out = PathBuf::from("./out/governance_ultimate_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            governance_residual_sweep(workdir, &residual_out)?;
            ...
            governance_absolute_sweep(workdir, &absolute_out)?;
            governance_terminal_sweep(workdir, &terminal_out)?;
            governance_ultimate_sweep(workdir, &ultimate_out)?;
            governance_convergence_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "convergence_status={:?} mismatch_categories={}",
    ...
    let governance_stabilization_sweep_smoke = out_smoke_check_with_skip(
        "governance_stabilization_sweep_smoke",
        "./out/governance_stabilization_sweep.json",
        |out_path| governance_stabilization_sweep(workdir, out_path),
        |report| {
            format!(
                "stabilization_status={:?} mismatch_categories={}",
    ...
    let supported_scope_execute_v8_smoke = out_smoke_check_with_skip(
        ...
        |out_path| {
            ...
            governance_absolute_sweep(
                workdir,
                &PathBuf::from("./out/governance_absolute_sweep.json"),
            )?;
            models_supported_scope_execute_v8(workdir, out_path)
        },
        |report| {
            format!(
                "decision={:?} slots={}",
    ...
    let governance_terminal_sweep_smoke = out_smoke_check_with_skip(
        "governance_terminal_sweep_smoke",
        ...
        |out_path| {
            ...
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            governance_absolute_sweep(workdir, &absolute_out)?;
            governance_terminal_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let supported_scope_execute_v9_smoke = out_smoke_check_with_skip(
        "supported_scope_execute_v9_smoke",
        ...
        |out_path| {
            ...
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            governance_terminal_sweep(workdir, &terminal_out)?;
            models_supported_scope_execute_v9(workdir, out_path)
        },
        |report| {
            format!(
                "decision={:?} slots={}",
    ...
    let residual_free_governance_sweep_smoke = {
        let out_path = PathBuf::from("./out/residual_free_governance_sweep.json");
        let prep = (|| -> Result<(), OpsError> {
            let review_out = PathBuf::from("./out/supported_set_review.json");
            let reeval_out = PathBuf::from("./out/supported_scope_reeval.json");
            let final_governance_out = PathBuf::from("./out/final_governance_consumer_sweep.json");
        ...
        let result = prep.and_then(|_| residual_free_governance_sweep(workdir, &out_path));
        match result {
            Ok(report) => PortabilityCommandCheck {
                name: "residual_free_governance_sweep_smoke".to_string(),
                status: if matches!(
                    report.authority.authority_status,
    ...
    let supported_scope_execute_v10_smoke = out_smoke_check_with_skip(
        ...
        |out_path| {
            ...
            governance_terminal_sweep(workdir, &terminal_out)?;
            governance_ultimate_sweep(workdir, &ultimate_out)?;
            models_supported_scope_execute_v10(workdir, out_path)
        },
        |report| {
            format!(
                "decision={:?} candidates={}",
    ...
    let supported_scope_execute_v11_smoke = out_smoke_check_with_skip(
        "supported_scope_execute_v11_smoke",
        "./out/supported_scope_execute_v11.json",
        |out_path| {
            let convergence_out = PathBuf::from("./out/governance_convergence_sweep.json");
            governance_convergence_sweep(workdir, &convergence_out)?;
            models_supported_scope_execute_v11(workdir, out_path)
        },
        |report| {
            format!(
                "decision={:?} candidates={}",
    ...
    let supported_scope_execute_v12_smoke = out_smoke_check_with_skip(
        "supported_scope_execute_v12_smoke",
        "./out/supported_scope_execute_v12.json",
        |out_path| {
            let stabilization_out = PathBuf::from("./out/governance_stabilization_sweep.json");
            governance_stabilization_sweep(workdir, &stabilization_out)?;
            models_supported_scope_execute_v12(workdir, out_path)
        },
        |report| {
            format!(
                "decision={:?} candidates={}",
    ...
    let residual_free_readiness_sweep_smoke = {
        let out_path = PathBuf::from("./out/residual_free_readiness_sweep.json");
        let prep = (|| -> Result<(), OpsError> {
            let review_out = PathBuf::from("./out/supported_set_review.json");
            let reeval_out = PathBuf::from("./out/supported_scope_reeval.json");
            let apply_out = PathBuf::from("./out/supported_set_apply.json");
            let final_readiness_out = PathBuf::from("./out/final_readiness_consumer_sweep.json");
            let residual_out = PathBuf::from("./out/readiness_residual_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            final_readiness_consumer_sweep(workdir, &final_readiness_out)?;
            readiness_residual_sweep(workdir, &residual_out)?;
            Ok(())
        })();
        let result = prep.and_then(|_| residual_free_readiness_sweep(workdir, &out_path));
        match result {
            Ok(report) => PortabilityCommandCheck {
                name: "residual_free_readiness_sweep_smoke".to_string(),
                status: if matches!(
                    report.authority.authority_status,
    ...
    let readiness_absolute_sweep_smoke = out_smoke_check_with_skip(
        "readiness_absolute_sweep_smoke",
        ...
        |out_path| {
            ...
            let final_readiness_out = PathBuf::from("./out/final_readiness_consumer_sweep.json");
            let residual_out = PathBuf::from("./out/readiness_residual_sweep.json");
            let residual_free_out = PathBuf::from("./out/residual_free_readiness_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            final_readiness_consumer_sweep(workdir, &final_readiness_out)?;
            readiness_residual_sweep(workdir, &residual_out)?;
            residual_free_readiness_sweep(workdir, &residual_free_out)?;
            readiness_absolute_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let readiness_terminal_sweep_smoke = out_smoke_check_with_skip(
        "readiness_terminal_sweep_smoke",
        "./out/readiness_terminal_sweep.json",
        |out_path| {
            let review_out = PathBuf::from("./out/supported_set_review.json");
            let reeval_out = PathBuf::from("./out/supported_scope_reeval.json");
            let apply_out = PathBuf::from("./out/supported_set_apply.json");
            let absolute_out = PathBuf::from("./out/readiness_absolute_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            readiness_absolute_sweep(workdir, &absolute_out)?;
            readiness_terminal_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let readiness_ultimate_sweep_smoke = out_smoke_check_with_skip(
        ...
        |out_path| {
            ...
            let residual_free_out = PathBuf::from("./out/residual_free_readiness_sweep.json");
            let absolute_out = PathBuf::from("./out/readiness_absolute_sweep.json");
            let terminal_out = PathBuf::from("./out/readiness_terminal_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            readiness_residual_sweep(workdir, &residual_out)?;
            residual_free_readiness_sweep(workdir, &residual_free_out)?;
            readiness_absolute_sweep(workdir, &absolute_out)?;
            readiness_terminal_sweep(workdir, &terminal_out)?;
            readiness_ultimate_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let readiness_convergence_sweep_smoke = out_smoke_check_with_skip(
        "readiness_convergence_sweep_smoke",
        "./out/readiness_convergence_sweep.json",
        |out_path| {
            let ultimate_out = PathBuf::from("./out/readiness_ultimate_sweep.json");
            readiness_ultimate_sweep(workdir, &ultimate_out)?;
            readiness_convergence_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "convergence_status={:?} mismatch_categories={}",
    ...
    let readiness_stabilization_sweep_smoke = out_smoke_check_with_skip(
        "readiness_stabilization_sweep_smoke",
        "./out/readiness_stabilization_sweep.json",
        |out_path| readiness_stabilization_sweep(workdir, out_path),
        |report| {
            format!(
                "stabilization_status={:?} mismatch_categories={}",
                report.sweep.stabilization_status,
    ...
    let residual_free_bundle_sweep_smoke = {
        let out_path = PathBuf::from("./out/residual_free_bundle_sweep.json");
        let prep = (|| -> Result<(), OpsError> {
            let review_out = PathBuf::from("./out/supported_set_review.json");
            let reeval_out = PathBuf::from("./out/supported_scope_reeval.json");
            let apply_out = PathBuf::from("./out/supported_set_apply.json");
            let final_bundle_out = PathBuf::from("./out/final_bundle_consumer_sweep.json");
            let residual_out = PathBuf::from("./out/bundle_residual_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            final_bundle_consumer_sweep(workdir, &final_bundle_out)?;
            bundle_residual_sweep(workdir, &residual_out)?;
            Ok(())
        })();
        let result = prep.and_then(|_| residual_free_bundle_sweep(workdir, &out_path));
        match result {
            Ok(report) => PortabilityCommandCheck {
                name: "residual_free_bundle_sweep_smoke".to_string(),
                status: if matches!(
                    report.authority.authority_status,
    ...
    let bundle_absolute_sweep_smoke = out_smoke_check_with_skip(
        "bundle_absolute_sweep_smoke",
        "./out/bundle_absolute_sweep.json",
        |out_path| {
            let review_out = PathBuf::from("./out/supported_set_review.json");
            let reeval_out = PathBuf::from("./out/supported_scope_reeval.json");
            ...
            let final_bundle_out = PathBuf::from("./out/final_bundle_consumer_sweep.json");
            let residual_out = PathBuf::from("./out/bundle_residual_sweep.json");
            let residual_free_out = PathBuf::from("./out/residual_free_bundle_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            final_bundle_consumer_sweep(workdir, &final_bundle_out)?;
            bundle_residual_sweep(workdir, &residual_out)?;
            residual_free_bundle_sweep(workdir, &residual_free_out)?;
            bundle_absolute_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let bundle_terminal_sweep_smoke = out_smoke_check_with_skip(
        "bundle_terminal_sweep_smoke",
        "./out/bundle_terminal_sweep.json",
        |out_path| {
            let review_out = PathBuf::from("./out/supported_set_review.json");
            let reeval_out = PathBuf::from("./out/supported_scope_reeval.json");
            let apply_out = PathBuf::from("./out/supported_set_apply.json");
            let absolute_out = PathBuf::from("./out/bundle_absolute_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            bundle_absolute_sweep(workdir, &absolute_out)?;
            bundle_terminal_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let bundle_ultimate_sweep_smoke = out_smoke_check_with_skip(
        ...
        |out_path| {
            ...
            let apply_out = PathBuf::from("./out/supported_set_apply.json");
            let absolute_out = PathBuf::from("./out/bundle_absolute_sweep.json");
            let terminal_out = PathBuf::from("./out/bundle_terminal_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            bundle_absolute_sweep(workdir, &absolute_out)?;
            bundle_terminal_sweep(workdir, &terminal_out)?;
            bundle_ultimate_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let bundle_convergence_sweep_smoke = out_smoke_check_with_skip(
        "bundle_convergence_sweep_smoke",
        "./out/bundle_convergence_sweep.json",
        |out_path| {
            let ultimate_out = PathBuf::from("./out/bundle_ultimate_sweep.json");
            bundle_ultimate_sweep(workdir, &ultimate_out)?;
            bundle_convergence_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "convergence_status={:?} mismatch_categories={}",
    ...
    let bundle_stabilization_sweep_smoke = out_smoke_check_with_skip(
        "bundle_stabilization_sweep_smoke",
        "./out/bundle_stabilization_sweep.json",
        |out_path| bundle_stabilization_sweep(workdir, out_path),
        |report| {
            format!(
                "stabilization_status={:?} mismatch_categories={}",
                report.sweep.stabilization_status,
    ...
    let residual_free_primary_semantics_sweep_smoke = {
        let out_path = PathBuf::from("./out/residual_free_primary_semantics_sweep.json");
        let prep = (|| -> Result<(), OpsError> {
            let review_out = PathBuf::from("./out/supported_set_review.json");
            let reeval_out = PathBuf::from("./out/supported_scope_reeval.json");
            let apply_out = PathBuf::from("./out/supported_set_apply.json");
            let final_primary_out = PathBuf::from("./out/final_primary_semantics_sweep.json");
            let residual_out = PathBuf::from("./out/primary_semantics_residual_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            final_primary_semantics_sweep(workdir, &final_primary_out)?;
            primary_semantics_residual_sweep(workdir, &residual_out)?;
            Ok(())
        })();
        let result = prep.and_then(|_| residual_free_primary_semantics_sweep(workdir, &out_path));
        match result {
            Ok(report) => PortabilityCommandCheck {
                name: "residual_free_primary_semantics_sweep_smoke".to_string(),
                status: if matches!(
                    report.authority.authority_status,
    ...
    let primary_semantics_absolute_sweep_smoke = out_smoke_check_with_skip(
        "primary_semantics_absolute_sweep_smoke",
        "./out/primary_semantics_absolute_sweep.json",
        |out_path| {
            let review_out = PathBuf::from("./out/supported_set_review.json");
            let reeval_out = PathBuf::from("./out/supported_scope_reeval.json");
            let apply_out = PathBuf::from("./out/supported_set_apply.json");
            let final_out = PathBuf::from("./out/final_primary_semantics_sweep.json");
            let residual_out = PathBuf::from("./out/primary_semantics_residual_sweep.json");
            let residual_free_out =
                PathBuf::from("./out/residual_free_primary_semantics_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            final_primary_semantics_sweep(workdir, &final_out)?;
            primary_semantics_residual_sweep(workdir, &residual_out)?;
            residual_free_primary_semantics_sweep(workdir, &residual_free_out)?;
            primary_semantics_absolute_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let primary_semantics_terminal_sweep_smoke = out_smoke_check_with_skip(
        "primary_semantics_terminal_sweep_smoke",
        "./out/primary_semantics_terminal_sweep.json",
        |out_path| {
            let review_out = PathBuf::from("./out/supported_set_review.json");
            let reeval_out = PathBuf::from("./out/supported_scope_reeval.json");
            let apply_out = PathBuf::from("./out/supported_set_apply.json");
            let absolute_out = PathBuf::from("./out/primary_semantics_absolute_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            primary_semantics_absolute_sweep(workdir, &absolute_out)?;
            primary_semantics_terminal_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let primary_semantics_ultimate_sweep_smoke = out_smoke_check_with_skip(
        ...
        |out_path| {
            ...
            let apply_out = PathBuf::from("./out/supported_set_apply.json");
            let absolute_out = PathBuf::from("./out/primary_semantics_absolute_sweep.json");
            let terminal_out = PathBuf::from("./out/primary_semantics_terminal_sweep.json");
            models_supported_set_review(workdir, &review_out)?;
            models_supported_scope_reevaluate(workdir, &reeval_out)?;
            let _ = models_supported_set_apply(workdir, &apply_out)?;
            primary_semantics_absolute_sweep(workdir, &absolute_out)?;
            primary_semantics_terminal_sweep(workdir, &terminal_out)?;
            primary_semantics_ultimate_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "sweep_status={:?} mismatch_categories={}",
    ...
    let primary_semantics_convergence_sweep_smoke = out_smoke_check_with_skip(
        "primary_semantics_convergence_sweep_smoke",
        "./out/primary_semantics_convergence_sweep.json",
        |out_path| {
            let ultimate_out = PathBuf::from("./out/primary_semantics_ultimate_sweep.json");
            primary_semantics_ultimate_sweep(workdir, &ultimate_out)?;
            primary_semantics_convergence_sweep(workdir, out_path)
        },
        |report| {
            format!(
                "convergence_status={:?} mismatch_categories={}",
    ...
    let primary_semantics_stabilization_sweep_smoke = out_smoke_check_with_skip(
        "primary_semantics_stabilization_sweep_smoke",
        "./out/primary_semantics_stabilization_sweep.json",
        |out_path| primary_semantics_stabilization_sweep(workdir, out_path),
        |report| {
            format!(
                "stabilization_status={:?} mismatch_categories={}",
                report.sweep.stabilization_status,
    ...
    command_matrix.push(matrix_cmd("linux", "cargo run -p ucf-ops -- readiness-final-consolidation-sweep --out ./out/readiness_final_consolidation_sweep.json"));
    command_matrix.push(matrix_cmd(
        "linux",
    ...
    command_matrix.push(matrix_cmd("windows", "cargo run -p ucf-ops -- readiness-final-consolidation-sweep --out ./out/readiness_final_consolidation_sweep.json"));
    command_matrix.push(matrix_cmd(
        "windows",
        "cargo run -p ucf-ops -- readiness-closure-sweep --out ./out/readiness_closure_sweep.json",
    ));
    ...
    let report = PortabilityReportV1 {
        ...
        residual_free_governance_sweep_smoke,
        governance_absolute_sweep_smoke,
        governance_terminal_sweep_smoke,
        governance_ultimate_sweep_smoke,
        governance_convergence_sweep_smoke,
...
mod repro_pack_tests {
    ...
    fn roundtrip_consistency_legacy_layout_is_explicit() {
        ...
        let report = evaluate_bundle_roundtrip_consistency(BundleRoundTripInputs {
            ...
            final_bundle_consumer_authority_digest_prefix: "MISSING",
            bundle_residual_sweep_digest_prefix: "MISSING",
            residual_free_bundle_consumer_authority_digest_prefix: "MISSING",
            bundle_absolute_sweep_digest_prefix: "MISSING",
            bundle_terminal_sweep_digest_prefix: "MISSING",
            bundle_ultimate_sweep_digest_prefix: "MISSING",
            bundle_convergence_sweep_digest_prefix: "MISSING",
