...
use ucf_ops::{
    ...
    governance_terminal_sweep, hardware_scan, interop_consistency_matrix,
    ...
    primary_semantics_absolute_sweep, primary_semantics_residual_sweep, primary_semantics_sweep,
    primary_semantics_terminal_sweep, readiness_absolute_sweep, readiness_gate,
    readiness_residual_sweep, readiness_spine_check, readiness_spine_sweep,
    readiness_terminal_sweep, release_build_rc, release_rc1_gate, release_signoff_validate,
    ...
    terminal_absolute_final_input_continuity_sweep, troubleshoot, v0_gate, v10_gate, v11_gate,
    v12_gate, v13_gate, v1_smoke, v2_gate, v3_gate, v4_gate, v5_gate, v6_gate, v7_gate, v8_gate,
    v9_gate, verify_bugreport, world_parity_report, world_shadow_report, write_slice,
    ...
    StrictEvidenceContextV1, TerminalAbsoluteFinalInputContinuityStatusV1, V10GateOverallStatus,
    V11GateOverallStatus, V12GateOverallStatus, V13GateOverallStatus, V2GateOverallStatus,
    ...
    match cmd {
        ...
        "models" => {
            ...
            match sub {
                ...
                _ => {
                    return Err(
                        "usage: ucf-ops models <verify|probe|stage|promote|rollback|list|active-check|active-evidence|eligibility|evidence-snapshot|active-review-snapshot|supported-set-review|supported-scope-reevaluate|supported-scope-execute|supported-scope-execute-v4|supported-scope-execute-v5|supported-scope-execute-v6|supported-scope-execute-v7|supported-scope-execute-v8|supported-scope-execute-v9|supported-set-apply|backend-resolution|consistency-check|applied-scope-check|recommend-rollback|shadow-ready> ..."
                            .into(),
                    )
                }
            }
        ...
        _ => {
            eprintln!(
                "usage: ucf-ops <bringup|diag|health|diagnostics|export-bugreport|verify-bugreport|replay-bugreport|replay|metrics-snapshot|explain-tick|metrics|models|security|attest|repro|exports|readiness-gate|preflight|goldens|nightly|dev|troubleshoot|adversarial-run|out|release|bench|runs|status|strict|ess|ebm|drift|alerts|operator|policy|portability|spec|change-impact|soak|governance-surfaces-check|governance-entry-check|governance-entry-sweep|final-governance-consumer-sweep|governance-residual-sweep|residual-free-governance-sweep|governance-absolute-sweep|governance-terminal-sweep|final-readiness-consumer-sweep|readiness-residual-sweep|residual-free-readiness-sweep|readiness-absolute-sweep|readiness-terminal-sweep|final-bundle-consumer-sweep|bundle-residual-sweep|residual-free-bundle-sweep|bundle-absolute-sweep|bundle-terminal-sweep|final-continuity-sweep|residual-free-continuity-sweep|absolute-final-input-continuity-sweep|terminal-absolute-final-input-continuity-sweep|remediation-consistency-check|remediation-interop-check|remediation-spine-check|primary-semantics-sweep|final-primary-semantics-sweep|primary-semantics-residual-sweep|residual-free-primary-semantics-sweep|primary-semantics-absolute-sweep|primary-semantics-terminal-sweep|interop|v0|v1|v2|v3|v4|v5|v6|v7|v8|v9|v10|v11|v12|v13|version> [--workdir <path>] [--bundle <path>]"
            );
            std::process::exit(1);
        }
    }
