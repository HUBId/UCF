...
use ucf_ops::{
    ...
    v5_gate, v6_gate, v7_gate, verify_bugreport, world_parity_report, world_shadow_report,
    ...
    GoldenGenerateArgs, GoldenVerifyArgs, GoldenVerifyReport, GovernanceEntryCheckStatusV1,
            ...
            match sub {
                ...
                "report" => {
                    ...
                    let has_fail = [
                        ...
                        &report.governance_entry_smoke,
                        &report.supported_scope_execute_v8_smoke,
                        &report.readiness_spine_smoke,
                        &report.bundle_spine_smoke,
                        &report.remediation_spine_smoke,
