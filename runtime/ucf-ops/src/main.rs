...
use ucf_ops::{
    ...
    readiness_absolute_sweep, readiness_convergence_sweep, readiness_final_consolidation_sweep,
    ...
    v13_gate, v14_gate, v15_gate, v16_gate, v17_gate, v1_smoke, v2_gate, v3_gate, v4_gate, v5_gate,
    ...
    CanonicalBundleAuthorityStatusV2, CanonicalReadinessAuthorityStatusV2,
    CanonicalStabilizationContinuityStatusV1, ChangeImpactArgs, ConfigV1,
    ContinuityAuthorityStatusV1, CounterfactualRequest, DevLoopArgs, DocsLintArgs, DocsLintMode,
    DocsLintStatus, ExplainTickRequest, ExportArgs, FinalBundleConsumerAuthorityStatusV1,
    ...
    ReadinessConvergenceStatusV1, ReadinessFinalConsolidationStatusV1,
    ...
    match cmd {
        ...
        "models" => {
            ...
            match sub {
                ...
                _ => {
                    return Err(
                        "usage: ucf-ops models <verify|probe|stage|promote|rollback|list|active-check|active-evidence|eligibility|evidence-snapshot|active-review-snapshot|supported-set-review|supported-scope-reevaluate|supported-scope-execute|supported-scope-execute-v4|supported-scope-execute-v5|supported-scope-execute-v6|supported-scope-execute-v7|supported-scope-execute-v8|supported-scope-execute-v9|supported-scope-execute-v10|supported-scope-execute-v11|supported-scope-execute-v12|supported-scope-execute-v13|supported-set-apply|backend-resolution|consistency-check|applied-scope-check|recommend-rollback|shadow-ready> ..."
                            .into(),
                    )
                }
            }
