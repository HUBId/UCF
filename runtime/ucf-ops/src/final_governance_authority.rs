...
pub const STABILIZED_CONVERGED_CANONICAL_GOVERNANCE_INPUTS_REQUIRED: &str =
    "STABILIZED_CONVERGED_CANONICAL_GOVERNANCE_INPUTS_REQUIRED";
pub const GOVERNANCE_FACADE_PATH_BLOCKED: &str = "GOVERNANCE_FACADE_PATH_BLOCKED";
pub const GOVERNANCE_FACADE_PATH_TRANSLATED: &str = "GOVERNANCE_FACADE_PATH_TRANSLATED";
pub const GOVERNANCE_FACADE_PATH_REJECTED: &str = "GOVERNANCE_FACADE_PATH_REJECTED";
pub const FINAL_CONSOLIDATED_STABILIZED_CANONICAL_GOVERNANCE_INPUTS_REQUIRED: &str =
    "FINAL_CONSOLIDATED_STABILIZED_CANONICAL_GOVERNANCE_INPUTS_REQUIRED";
pub const GOVERNANCE_WRAPPER_PATH_BLOCKED: &str = "GOVERNANCE_WRAPPER_PATH_BLOCKED";
pub const GOVERNANCE_WRAPPER_PATH_TRANSLATED: &str = "GOVERNANCE_WRAPPER_PATH_TRANSLATED";
pub const GOVERNANCE_WRAPPER_PATH_REJECTED: &str = "GOVERNANCE_WRAPPER_PATH_REJECTED";
pub const CLOSURE_COMPLETE_FINAL_CONSOLIDATED_STABILIZED_CANONICAL_GOVERNANCE_INPUTS_REQUIRED:
    &str = "CLOSURE_COMPLETE_FINAL_CONSOLIDATED_STABILIZED_CANONICAL_GOVERNANCE_INPUTS_REQUIRED";
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct GovernanceFinalConsolidationInputsV1 {
    pub applied_supported_set_digest_prefix: String,
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_governance_authority_digest_prefix: String,
    pub final_governance_consumer_authority_digest_prefix: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct GovernanceClosureInputsV1 {
    pub applied_supported_set_digest_prefix: String,
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_governance_authority_digest_prefix: String,
    pub final_governance_consumer_authority_digest_prefix: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct GovernanceSealInputsV1 {
    pub applied_supported_set_digest_prefix: String,
    pub canonical_governance_entry_digest_prefix: String,
    pub canonical_governance_authority_digest_prefix: String,
    pub final_governance_consumer_authority_digest_prefix: String,
...
#[allow(clippy::too_many_arguments)]
pub fn require_governance_final_consolidation_inputs(
    applied: Option<&AppliedSupportedSetContextV1>,
    entry: Option<&CanonicalGovernanceEntryV1>,
    authority: Option<&CanonicalGovernanceEntryAuthorityV2>,
    final_consumer: Option<&FinalGovernanceConsumerAuthorityV1>,
...
) -> Result<GovernanceFinalConsolidationInputsV1, OpsError> {
    let stabilization_inputs = require_governance_stabilization_inputs(
        applied,
        entry,
        authority,
        final_consumer,
    ...
    let Some(stabilization_sweep) = stabilization_sweep else {
        return Err(OpsError::Invalid(
            STABILIZED_CONVERGED_CANONICAL_GOVERNANCE_INPUTS_REQUIRED.to_string(),
        ));
    };
    let expected_stabilization_prefix = prefix_hex(&stabilization_sweep.stabilization_digest, 16);
    if !matches!(
        ...
        || stabilization_sweep.canonical_governance_authority_digest_prefix
            != stabilization_inputs.canonical_governance_authority_digest_prefix
        || stabilization_sweep.final_governance_consumer_authority_digest_prefix
            != stabilization_inputs.final_governance_consumer_authority_digest_prefix
        || stabilization_sweep.final_governance_residual_sweep_digest_prefix
            != stabilization_inputs.final_governance_residual_sweep_digest_prefix
        || stabilization_sweep.residual_free_governance_consumer_authority_digest_prefix
            != stabilization_inputs.residual_free_governance_consumer_authority_digest_prefix
        || stabilization_sweep.residual_free_governance_absolute_sweep_digest_prefix
            != stabilization_inputs.residual_free_governance_absolute_sweep_digest_prefix
        || stabilization_sweep.absolute_final_governance_terminal_sweep_digest_prefix
            != stabilization_inputs.absolute_final_governance_terminal_sweep_digest_prefix
        || stabilization_sweep.terminal_governance_ultimate_sweep_digest_prefix
            != stabilization_inputs.terminal_governance_ultimate_sweep_digest_prefix
        || stabilization_sweep.governance_convergence_sweep_digest_prefix
            != stabilization_inputs.governance_convergence_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(
            GOVERNANCE_FACADE_PATH_BLOCKED.to_string(),
        ));
    }

    let mut bytes = Vec::new();
    bytes.extend_from_slice(b"governance_final_consolidation_inputs_v1");
    bytes.extend_from_slice(
    ...
    bytes.extend_from_slice(expected_stabilization_prefix.as_bytes());

    Ok(GovernanceFinalConsolidationInputsV1 {
        applied_supported_set_digest_prefix: stabilization_inputs
            .applied_supported_set_digest_prefix,
        canonical_governance_entry_digest_prefix: stabilization_inputs
            .canonical_governance_entry_digest_prefix,
        canonical_governance_authority_digest_prefix: stabilization_inputs
            .canonical_governance_authority_digest_prefix,
        final_governance_consumer_authority_digest_prefix: stabilization_inputs
            .final_governance_consumer_authority_digest_prefix,
        final_governance_residual_sweep_digest_prefix: stabilization_inputs
            .final_governance_residual_sweep_digest_prefix,
        residual_free_governance_consumer_authority_digest_prefix: stabilization_inputs
            .residual_free_governance_consumer_authority_digest_prefix,
        residual_free_governance_absolute_sweep_digest_prefix: stabilization_inputs
            .residual_free_governance_absolute_sweep_digest_prefix,
        absolute_final_governance_terminal_sweep_digest_prefix: stabilization_inputs
            .absolute_final_governance_terminal_sweep_digest_prefix,
        terminal_governance_ultimate_sweep_digest_prefix: stabilization_inputs
            .terminal_governance_ultimate_sweep_digest_prefix,
        governance_convergence_sweep_digest_prefix: stabilization_inputs
            .governance_convergence_sweep_digest_prefix,
        governance_stabilization_sweep_digest_prefix: expected_stabilization_prefix,
        authority_digest: crate::sha256_hex(&bytes),
    })
}

#[allow(clippy::too_many_arguments)]
pub fn require_governance_closure_inputs(
    applied: Option<&AppliedSupportedSetContextV1>,
    entry: Option<&CanonicalGovernanceEntryV1>,
    authority: Option<&CanonicalGovernanceEntryAuthorityV2>,
    final_consumer: Option<&FinalGovernanceConsumerAuthorityV1>,
...
) -> Result<GovernanceClosureInputsV1, OpsError> {
    let consolidation_inputs = require_governance_final_consolidation_inputs(
        applied,
        entry,
        authority,
        final_consumer,
    ...
    let Some(final_consolidation_sweep) = final_consolidation_sweep else {
        return Err(OpsError::Invalid(
            FINAL_CONSOLIDATED_STABILIZED_CANONICAL_GOVERNANCE_INPUTS_REQUIRED.to_string(),
        ));
    };
    ...
    if !matches!(
        ...
        || final_consolidation_sweep.canonical_governance_authority_digest_prefix
            != consolidation_inputs.canonical_governance_authority_digest_prefix
        || final_consolidation_sweep.final_governance_consumer_authority_digest_prefix
            != consolidation_inputs.final_governance_consumer_authority_digest_prefix
        || final_consolidation_sweep.final_governance_residual_sweep_digest_prefix
            != consolidation_inputs.final_governance_residual_sweep_digest_prefix
        || final_consolidation_sweep.residual_free_governance_consumer_authority_digest_prefix
            != consolidation_inputs.residual_free_governance_consumer_authority_digest_prefix
        || final_consolidation_sweep.residual_free_governance_absolute_sweep_digest_prefix
            != consolidation_inputs.residual_free_governance_absolute_sweep_digest_prefix
        || final_consolidation_sweep.absolute_final_governance_terminal_sweep_digest_prefix
            != consolidation_inputs.absolute_final_governance_terminal_sweep_digest_prefix
        || final_consolidation_sweep.terminal_governance_ultimate_sweep_digest_prefix
            != consolidation_inputs.terminal_governance_ultimate_sweep_digest_prefix
        || final_consolidation_sweep.governance_convergence_sweep_digest_prefix
            != consolidation_inputs.governance_convergence_sweep_digest_prefix
        || final_consolidation_sweep.governance_stabilization_sweep_digest_prefix
            != consolidation_inputs.governance_stabilization_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(
            GOVERNANCE_WRAPPER_PATH_BLOCKED.to_string(),
        ));
    }
    let mut bytes = Vec::new();
    bytes.extend_from_slice(b"governance_closure_inputs_v1");
    bytes.extend_from_slice(
    ...
    Ok(GovernanceClosureInputsV1 {
        applied_supported_set_digest_prefix: consolidation_inputs
            .applied_supported_set_digest_prefix,
        canonical_governance_entry_digest_prefix: consolidation_inputs
            .canonical_governance_entry_digest_prefix,
        canonical_governance_authority_digest_prefix: consolidation_inputs
            .canonical_governance_authority_digest_prefix,
        final_governance_consumer_authority_digest_prefix: consolidation_inputs
            .final_governance_consumer_authority_digest_prefix,
        final_governance_residual_sweep_digest_prefix: consolidation_inputs
            .final_governance_residual_sweep_digest_prefix,
        residual_free_governance_consumer_authority_digest_prefix: consolidation_inputs
            .residual_free_governance_consumer_authority_digest_prefix,
        residual_free_governance_absolute_sweep_digest_prefix: consolidation_inputs
            .residual_free_governance_absolute_sweep_digest_prefix,
        absolute_final_governance_terminal_sweep_digest_prefix: consolidation_inputs
            .absolute_final_governance_terminal_sweep_digest_prefix,
        terminal_governance_ultimate_sweep_digest_prefix: consolidation_inputs
            .terminal_governance_ultimate_sweep_digest_prefix,
        governance_convergence_sweep_digest_prefix: consolidation_inputs
            .governance_convergence_sweep_digest_prefix,
        governance_stabilization_sweep_digest_prefix: consolidation_inputs
            .governance_stabilization_sweep_digest_prefix,
        governance_final_consolidation_sweep_digest_prefix: expected_final_consolidation_prefix,
        authority_digest: crate::sha256_hex(&bytes),
    })
}

#[allow(clippy::too_many_arguments)]
pub fn require_governance_seal_inputs(
    applied: Option<&AppliedSupportedSetContextV1>,
    entry: Option<&CanonicalGovernanceEntryV1>,
    authority: Option<&CanonicalGovernanceEntryAuthorityV2>,
    final_consumer: Option<&FinalGovernanceConsumerAuthorityV1>,
...
) -> Result<GovernanceSealInputsV1, OpsError> {
    let closure_inputs = require_governance_closure_inputs(
        applied,
        entry,
        authority,
        final_consumer,
    ...
    if !matches!(
        ...
        || closure_sweep.canonical_governance_authority_digest_prefix
            != closure_inputs.canonical_governance_authority_digest_prefix
        || closure_sweep.final_governance_consumer_authority_digest_prefix
            != closure_inputs.final_governance_consumer_authority_digest_prefix
        || closure_sweep.final_governance_residual_sweep_digest_prefix
            != closure_inputs.final_governance_residual_sweep_digest_prefix
        || closure_sweep.residual_free_governance_consumer_authority_digest_prefix
            != closure_inputs.residual_free_governance_consumer_authority_digest_prefix
        || closure_sweep.residual_free_governance_absolute_sweep_digest_prefix
            != closure_inputs.residual_free_governance_absolute_sweep_digest_prefix
        || closure_sweep.absolute_final_governance_terminal_sweep_digest_prefix
            != closure_inputs.absolute_final_governance_terminal_sweep_digest_prefix
        || closure_sweep.terminal_governance_ultimate_sweep_digest_prefix
            != closure_inputs.terminal_governance_ultimate_sweep_digest_prefix
        || closure_sweep.governance_convergence_sweep_digest_prefix
            != closure_inputs.governance_convergence_sweep_digest_prefix
        || closure_sweep.governance_stabilization_sweep_digest_prefix
            != closure_inputs.governance_stabilization_sweep_digest_prefix
        || closure_sweep.governance_final_consolidation_sweep_digest_prefix
            != closure_inputs.governance_final_consolidation_sweep_digest_prefix
    {
        return Err(OpsError::Invalid(GOVERNANCE_SHELL_PATH_BLOCKED.to_string()));
    }

    let mut bytes = Vec::new();
    bytes.extend_from_slice(b"governance_seal_inputs_v1");
    bytes.extend_from_slice(
        closure_inputs
            .applied_supported_set_digest_prefix
            .as_bytes(),
    ...
    Ok(GovernanceSealInputsV1 {
        ...
        canonical_governance_entry_digest_prefix: closure_inputs
            .canonical_governance_entry_digest_prefix,
        canonical_governance_authority_digest_prefix: closure_inputs
            .canonical_governance_authority_digest_prefix,
        final_governance_consumer_authority_digest_prefix: closure_inputs
            .final_governance_consumer_authority_digest_prefix,
        final_governance_residual_sweep_digest_prefix: closure_inputs
            .final_governance_residual_sweep_digest_prefix,
        residual_free_governance_consumer_authority_digest_prefix: closure_inputs
            .residual_free_governance_consumer_authority_digest_prefix,
        residual_free_governance_absolute_sweep_digest_prefix: closure_inputs
            .residual_free_governance_absolute_sweep_digest_prefix,
        absolute_final_governance_terminal_sweep_digest_prefix: closure_inputs
            .absolute_final_governance_terminal_sweep_digest_prefix,
        terminal_governance_ultimate_sweep_digest_prefix: closure_inputs
            .terminal_governance_ultimate_sweep_digest_prefix,
        governance_convergence_sweep_digest_prefix: closure_inputs
            .governance_convergence_sweep_digest_prefix,
        governance_stabilization_sweep_digest_prefix: closure_inputs
            .governance_stabilization_sweep_digest_prefix,
