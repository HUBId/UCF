...
fn build_packet(
    ...
    Ok(OperatorReviewPacketV1 {
        ...
        readiness_final_consolidation_sweep_digest_prefix: signoff
            ...
            .clone(),
        readiness_closure_sweep_digest_prefix: signoff
            .readiness_closure_sweep_digest_prefix
            .clone(),
        readiness_seal_sweep_digest_prefix: signoff.readiness_seal_sweep_digest_prefix.clone(),
        ...
        governance_closure_sweep_digest_prefix: signoff
            ...
            .clone(),
        governance_seal_sweep_digest_prefix: signoff.governance_seal_sweep_digest_prefix.clone(),
