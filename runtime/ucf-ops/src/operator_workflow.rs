...
pub fn operator_workflow_chain(
    ...
    .unwrap_or_else(|| "MISSING".to_string());
    chain.readiness_final_consolidation_sweep_digest_prefix = discover_digest_prefix(
        &out_root,
        "readiness_final_consolidation_sweep.json",
        "sweep.consolidation_digest",
    )
    .unwrap_or_else(|| "MISSING".to_string());
    chain.readiness_closure_sweep_digest_prefix = discover_digest_prefix(
        &out_root,
        "readiness_closure_sweep.json",
        "sweep.closure_digest",
    )
    .unwrap_or_else(|| "MISSING".to_string());
    chain.readiness_seal_sweep_digest_prefix =
        discover_digest_prefix(&out_root, "readiness_seal_sweep.json", "sweep.seal_digest")
            .unwrap_or_else(|| "MISSING".to_string());
    chain.governance_final_consolidation_sweep_digest_prefix = discover_digest_prefix(
        &out_root,
        "governance_final_consolidation_sweep.json",
        "sweep.consolidation_digest",
    )
    .unwrap_or_else(|| "MISSING".to_string());
    chain.governance_closure_sweep_digest_prefix = discover_digest_prefix(
        &out_root,
        "governance_closure_sweep.json",
        "sweep.closure_digest",
    )
    .unwrap_or_else(|| "MISSING".to_string());
    chain.governance_seal_sweep_digest_prefix =
        discover_digest_prefix(&out_root, "governance_seal_sweep.json", "sweep.seal_digest")
            .unwrap_or_else(|| "MISSING".to_string());
    ...
    .unwrap_or_else(|| "MISSING".to_string());
    chain.canonical_final_consolidation_continuity_authority_digest_prefix =
        discover_digest_prefix(
            &out_root,
            "canonical_final_consolidation_continuity_sweep.json",
            "authority_digest",
        )
        .unwrap_or_else(|| "MISSING".to_string());
