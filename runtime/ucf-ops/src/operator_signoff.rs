...
pub fn operator_signoff(
    ...
    decision.absolute_final_governance_terminal_sweep_digest_prefix = read_sweep_digest_prefix(
        workdir,
        "out/governance_terminal_sweep.json",
        "sweep.sweep_digest",
    );
    decision.governance_ultimate_sweep_digest_prefix = read_sweep_digest_prefix(
        workdir,
    ...
    decision.readiness_absolute_sweep_digest_prefix =
        read_sweep_digest_prefix(workdir, "out/readiness_absolute_sweep.json", "sweep_digest");
    decision.readiness_terminal_sweep_digest_prefix =
        read_sweep_digest_prefix(workdir, "out/readiness_terminal_sweep.json", "sweep_digest");
    decision.readiness_ultimate_sweep_digest_prefix = read_sweep_digest_prefix(
        workdir,
    ...
    decision.readiness_final_consolidation_sweep_digest_prefix = read_sweep_digest_prefix(
        workdir,
        "out/readiness_final_consolidation_sweep.json",
        "sweep.consolidation_digest",
    );
    decision.governance_final_consolidation_sweep_digest_prefix = read_sweep_digest_prefix(
        workdir,
    ...
    decision.governance_seal_sweep_digest_prefix = read_sweep_digest_prefix(
        workdir,
    ...
    decision.residual_free_primary_semantics_authority_digest_prefix = read_sweep_digest_prefix(
        workdir,
    ...
    decision.primary_semantics_terminal_sweep_digest_prefix = read_sweep_digest_prefix(
        workdir,
        "out/primary_semantics_terminal_sweep.json",
        "sweep.sweep_digest",
    );
    decision.primary_semantics_ultimate_sweep_digest_prefix = read_sweep_digest_prefix(
        workdir,
        "out/primary_semantics_ultimate_sweep.json",
        "sweep.sweep_digest",
    );
    decision.primary_semantics_convergence_sweep_digest_prefix = read_sweep_digest_prefix(
        workdir,
