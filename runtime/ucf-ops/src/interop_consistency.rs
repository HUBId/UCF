...
pub fn interop_consistency_matrix(
    ...
    let matrix = CrossSurfaceContextMatrixV1 {
        ...
        governance_residual_sweep_digest_prefix: operator_review
            ...
            .unwrap_or_else(|| "MISSING".to_string()),
        residual_free_governance_authority_digest_prefix: operator_review
            .as_ref()
            .map(|review| {
                review
        ...
        readiness_absolute_sweep_digest_prefix: operator_review
            ...
            .unwrap_or_else(|| "MISSING".to_string()),
        readiness_terminal_sweep_digest_prefix: operator_review
            .as_ref()
            .map(|review| review.readiness_terminal_sweep_digest_prefix.clone())
            .unwrap_or_else(|| "MISSING".to_string()),
        readiness_ultimate_sweep_digest_prefix: operator_review
            .as_ref()
            .map(|review| review.readiness_ultimate_sweep_digest_prefix.clone())
            .unwrap_or_else(|| "MISSING".to_string()),
        readiness_stabilization_sweep_digest_prefix: operator_review
            .as_ref()
            .map(|review| review.readiness_stabilization_sweep_digest_prefix.clone())
            .unwrap_or_else(|| "MISSING".to_string()),
        readiness_final_consolidation_sweep_digest_prefix: operator_review
            .as_ref()
            .map(|review| {
                review
        ...
        governance_final_consolidation_sweep_digest_prefix: operator_review
            ...
            .unwrap_or_else(|| "MISSING".to_string()),
        governance_closure_sweep_digest_prefix: operator_review
            .as_ref()
            .map(|review| review.governance_closure_sweep_digest_prefix.clone())
            .unwrap_or_else(|| "MISSING".to_string()),
        governance_seal_sweep_digest_prefix: operator_review
            .as_ref()
            .map(|review| review.governance_seal_sweep_digest_prefix.clone())
            .unwrap_or_else(|| "MISSING".to_string()),
        ...
        primary_semantics_absolute_sweep_digest_prefix: operator_review
            ...
            .unwrap_or_else(|| "MISSING".to_string()),
        primary_semantics_terminal_sweep_digest_prefix: operator_review
            .as_ref()
            .map(|review| {
                review
