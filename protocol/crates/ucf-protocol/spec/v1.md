...
### CandidateSetRecord
A minimal protocol-facing record for deterministic candidate materialization. It records candidate
commitments only and does not imply real compute or execution authority.

| Tag | Field | Type |
| --- | --- | --- |
| 1 | version | u32 |
| 2 | input_digest | bytes |
| 3 | policy_decision_digest | bytes |
| 4 | candidate_count | u32 |
| 5 | candidate_digests | repeated bytes (sorted) |
| 6 | candidates_digest | bytes |
| 7 | provenance | string |

### OutputRecord
A minimal protocol-facing record for the selected/output materialization commitment. It records
commitments and status only; it is not a gateway response, real inference result, or execution grant.

| Tag | Field | Type |
| --- | --- | --- |
| 1 | version | u32 |
| 2 | input_digest | bytes |
| 3 | candidate_set_digest | bytes |
| 4 | selected_candidate_digest | bytes |
| 5 | output_digest | bytes |
| 6 | policy_status | string |
| 7 | status | string |
| 8 | provenance | string |
| 9 | evidence_id | string? |
