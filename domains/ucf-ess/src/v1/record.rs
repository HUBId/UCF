...
pub struct ExperienceRecord {
    ...
    pub world_summary_record: Option<WorldSummaryRecord>,
    pub sae_summary_record: Option<SaeSummaryRecord>,
    pub ssm_summary_record: Option<SsmSummaryRecord>,
    pub lfm_summary_record: Option<LfmSummaryRecord>,
    pub llm_summary_record: Option<LlmSummaryRecord>,
    pub signal_bundle_record: Option<SignalBundleRecordV1>,
    pub decision_inputs_record: Option<DecisionInputsRecordV1>,
...
pub struct HormoneRecord {
    ...
    pub cortisol_q: u16,
    pub dopamine_q: u16,
    pub norepinephrine_q: u16,
    pub serotonin_q: u16,
    pub acetylcholine_q: u16,
    pub drive_q: u16,
    pub stress_index_q: u16,
    pub attention_gain_q: Option<u16>,
    pub plasticity_gate_q: Option<u16>,
    pub stress_gate_q: Option<u16>,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SaeSummaryRecord {
    pub t: u64,
    pub contract_version: u16,
    pub backend_id: u16,
    pub spike_count: u16,
    pub spikes_digest_prefix: [u8; 8],
    pub top_spikes: Vec<(u16, u16)>,
    pub policy_graph_digest_prefix: [u8; 8],
    pub evidence_chain_digest_prefix: [u8; 8],
    pub validation_status: u8,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct LlmSummaryRecord {
    pub t: u64,
    pub contract_version: u16,
    pub backend_id: u16,
    pub token_count: u16,
    pub response_digest_prefix: [u8; 8],
    pub policy_graph_digest_prefix: [u8; 8],
    pub evidence_chain_digest_prefix: [u8; 8],
    pub validation_status: u8,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct SignalBundleRecordV1 {
    pub t: u64,
    pub risk_q: u16,
    ...
    pub signals_digest_prefix: [u8; 8],
    pub world_prediction_digest_prefix: [u8; 8],
    pub sae_spikes_digest_prefix: [u8; 8],
    pub ssm_state_digest_prefix: [u8; 8],
    pub lfm_state_digest_prefix: [u8; 8],
    pub policy_graph_digest_prefix: [u8; 8],
    pub evidence_chain_digest_prefix: [u8; 8],
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct DecisionInputsRecordV1 {
    pub t: u64,
    pub run_id: u64,
    pub policy_graph_digest_prefix: [u8; 8],
    pub signals_digest_prefix: [u8; 8],
    ...
    pub confidence_q: u16,
    pub governor_tier: u8,
    pub gating_status: u8,
    pub top_candidates_digest_prefix: Option<[u8; 8]>,
    pub has_tool_intent: bool,
    pub has_network_intent: bool,
    pub has_filesystem_intent: bool,
    pub evidence_chain_digest_prefix: [u8; 8],
}
...
impl ExperienceRecord {
    ...
    pub fn from_world_summary(
        id: ExperienceId,
        time: SimTime,
        corr: CorrelationId,
        world_summary_record: WorldSummaryRecord,
    ) -> Self {
        Self {
            id,
            time,
            corr,
            kind: ExperienceKind::WorldSummary,
            payload: ExperiencePayload::Empty,
            neuromod: None,
            iit_phi: None,
            decision_meta: None,
            ...
            nsr_record: None,
            backend_pack_record: None,
            world_summary_record: Some(world_summary_record),
            sae_summary_record: None,
            ssm_summary_record: None,
            lfm_summary_record: None,
            llm_summary_record: None,
    ...
    pub fn from_sae_summary(
        id: ExperienceId,
        time: SimTime,
        corr: CorrelationId,
        sae_summary_record: SaeSummaryRecord,
    ) -> Self {
        Self {
            id,
            time,
            corr,
            kind: ExperienceKind::SaeSummary,
            payload: ExperiencePayload::Empty,
            neuromod: None,
            iit_phi: None,
            decision_meta: None,
            ...
            backend_pack_record: None,
            world_summary_record: None,
            sae_summary_record: Some(sae_summary_record),
            ssm_summary_record: None,
            lfm_summary_record: None,
            llm_summary_record: None,
            signal_bundle_record: None,
    ...
    pub fn from_ssm_summary(
        id: ExperienceId,
        time: SimTime,
        corr: CorrelationId,
        ssm_summary_record: SsmSummaryRecord,
    ) -> Self {
        Self {
            id,
            time,
            corr,
            kind: ExperienceKind::SsmSummary,
            payload: ExperiencePayload::Empty,
            neuromod: None,
            iit_phi: None,
            decision_meta: None,
            ...
            world_summary_record: None,
            sae_summary_record: None,
            ssm_summary_record: Some(ssm_summary_record),
            lfm_summary_record: None,
            llm_summary_record: None,
            signal_bundle_record: None,
            decision_inputs_record: None,
    ...
    pub fn from_llm_summary(
        id: ExperienceId,
        time: SimTime,
        corr: CorrelationId,
        llm_summary_record: LlmSummaryRecord,
    ) -> Self {
        Self {
            id,
            time,
            corr,
            kind: ExperienceKind::LlmSummary,
            payload: ExperiencePayload::Empty,
            neuromod: None,
            iit_phi: None,
            decision_meta: None,
            ...
            ssm_summary_record: None,
            lfm_summary_record: None,
            llm_summary_record: Some(llm_summary_record),
            signal_bundle_record: None,
            decision_inputs_record: None,
            lfm_window_record: None,
            ebm_tag: None,
    ...
    pub fn from_signal_bundle(
        ...
        time: SimTime,
        corr: CorrelationId,
        signal_bundle_record: SignalBundleRecordV1,
    ) -> Self {
        Self {
            id,
            time,
            corr,
            kind: ExperienceKind::SignalBundle,
            payload: ExperiencePayload::Empty,
            neuromod: None,
            iit_phi: None,
            decision_meta: None,
            ...
            lfm_summary_record: None,
            llm_summary_record: None,
            signal_bundle_record: Some(signal_bundle_record),
            decision_inputs_record: None,
            lfm_window_record: None,
            ebm_tag: None,
            audit_prev_digest: None,
    ...
    pub fn from_decision_inputs(
        ...
        time: SimTime,
        corr: CorrelationId,
        decision_inputs_record: DecisionInputsRecordV1,
    ) -> Self {
        Self {
            id,
            time,
            corr,
            kind: ExperienceKind::DecisionInputs,
            payload: ExperiencePayload::Empty,
            neuromod: None,
            iit_phi: None,
            decision_meta: None,
            ...
            llm_summary_record: None,
            signal_bundle_record: None,
            decision_inputs_record: Some(decision_inputs_record),
            lfm_window_record: None,
            ebm_tag: None,
            audit_prev_digest: None,
            audit_digest: None,
