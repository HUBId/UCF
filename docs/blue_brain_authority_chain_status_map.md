...
Die kompakte maintenance-facing Discoverability-Map ist `docs/blue_brain_maintenance_discoverability_map_v1.md`; das Shadow-Surface-Inventar ist `docs/blue_brain_non_canonical_shadow_surface_inventory_v1.md`; die kanonische sechs-Regionen-Inventar-/Rollenkarte ist `docs/blue_brain_canonical_region_inventory_map_v1.md`; der finale Regionen-/Relationen-/Modellmodi-Matrix-Freeze ist `docs/blue_brain_canonical_matrices_final_freeze_v1.md`; die Guard-/Semantic-Drift-Map ist `docs/blue_brain_guard_semantic_drift_map_v1.md`; die Discoverability-Findings-Map ist `docs/blue_brain_discoverability_findings_map_v1.md`; die aktuelle Maintenance-Action-Map ist `docs/blue_brain_current_maintenance_action_map_v1.md`; die Discoverability-Cleanup-Abschlussnotiz ist `docs/blue_brain_discoverability_cleanup_pass_v1.md`; die Completion-third-deepening closure ist `docs/blue_brain_completion_third_deepening_decision_closure_v1.md`. Diese Dateien sind Supporting References, nicht zweite Wahrheitsquellen.
