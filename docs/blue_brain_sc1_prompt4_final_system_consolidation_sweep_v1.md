...
- Reproduzierbarkeit: Die aktuelle post-BR6/SC1 Baseline liegt unter `out/blue_brain_audit_baseline_2026-05-09_head_9f263aac7e/`; root-level `out/docs_lint_report.json` und `out/gate_report.json` bleiben die Standardberichte.
...
- Repro/audit evidence is refreshed on HEAD `9f263aac7e146bf58c65c8f17e467ec710486100` for a repo-based handoff.
