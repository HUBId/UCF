...
- Reproduzierbarkeit: Die aktuelle post-BR6/SC1 Baseline liegt unter `out/blue_brain_audit_baseline_2026-05-09_head_ffa017d613/`; root-level `out/docs_lint_report.json` und `out/gate_report.json` bleiben die Standardberichte.
...
- Repro/audit evidence is refreshed on HEAD `ffa017d6138397d2f674a3b2405ca9ef22d3463b` for a repo-based handoff.
