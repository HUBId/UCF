...
- Reproduzierbarkeit: Die aktuelle post-BR6/SC1 Baseline liegt unter `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/`; root-level `out/docs_lint_report.json` und `out/gate_report.json` bleiben die Standardberichte.
...
- Repro/audit evidence is refreshed on HEAD `13615edd74b3e4da27036ceb82b45c78e85b0770` for a repo-based handoff.
