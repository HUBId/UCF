...
| `docs/roadmap/sleep_integration_roadmap_boundary_audit.md` | Current authoritative architecture docs | yes | Current Sleep planning and boundary audit; inventories existing sleep coordinator/report code, Replay audit/applied-boundary inputs, Geist/ISM risks, Evidence/Archive authority limits, and the Prompt 47-56 Sleep prompt series without implementing Sleep behavior. | `core/crates/ucf-sleep-coordinator`, `core/crates/ucf-rsa`, `core/crates/ucf-tcf`, `runtime/ucf-replay`, `domains/geist`, `domains/consolidation`, `runtime/ucf-ops`, `.github/workflows` | canonical-planning |
| `docs/roadmap/sleep_record_authority_schema_alignment.md` | Current authoritative architecture docs | yes | Prompt 47 authority alignment for Sleep-facing records; confirms SleepPlan/SleepCycle/SleepApplied/SleepBoundary are not canonical yet, keeps existing sleep coordinator/report code as prototype inventory, defers protocol/types promotion, and defines Prompt 48 deterministic SleepPlan candidate acceptance criteria without runtime Sleep, Geist/ISM, identity, Gateway, or Evidence/Archive append behavior. | `core/crates/ucf-sleep-coordinator`, `core/crates/ucf-rsa`, `runtime/ucf-replay`, `domains/geist`, `core/crates/ucf-types`, `protocol/crates/ucf-protocol`, `core/crates/ucf-evidence`, `domains/archive` | canonical-planning |
