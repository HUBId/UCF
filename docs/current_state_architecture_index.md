...
| `docs/roadmap/geist_ism_roadmap_boundary_audit.md` | Current authoritative architecture docs | yes | Current Geist/ISM planning and boundary audit; inventories existing SelfState, Geist loop, ISM upsert, archive append, Sleep coupling, bounded Sleep/Replay/Consolidation provenance, and identity-anchor risks while recommending Prompt 56 for record authority and schema alignment without implementing projection, ISM writes, identity finalization, Gateway authority, Policy mutation, or Evidence/Archive append. | `domains/geist`, `core/crates/ucf-sleep-coordinator`, `runtime/ucf-replay`, `domains/consolidation`, `core/crates/ucf-evidence`, `domains/archive`, `runtime/ucf-ops`, `.github/workflows` | canonical-planning |
| `docs/roadmap/geist_ism_record_authority_schema_alignment.md` | Current authoritative architecture docs | yes | Prompt 56 docs-only Geist/ISM record-authority alignment; records existing SelfState/Geist/ISM/identity surfaces, selects local bounded `ucf-geist` candidate/audit/boundary authority for a later prompt, and keeps existing ISM upsert, Archive append, Sleep mutation, Policy mutation, Gateway action, and identity-anchor/finalization behavior deferred. | `domains/geist`, `core/crates/ucf-sleep-coordinator`, `runtime/ucf-replay`, `domains/consolidation`, `core/crates/ucf-evidence`, `domains/archive`, `core/crates/ucf-policy-ecology` | canonical-planning |
