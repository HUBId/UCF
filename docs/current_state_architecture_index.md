...
- Use the replay roadmap and record-authority alignment guard before making replay claims; Prompt 42 proves bounded Replay E2E determinism only, not runtime apply, scheduler/queue/worker, Sleep/Geist/ISM/identity, Evidence/Archive append, or Gateway readiness.
