...
Use this index as the reading order for roadmap prompts. Policy Ecology authority/schema alignment is tracked in `docs/roadmap/policy_record_authority_schema_alignment.md` (P2, read-only boundary alignment; no runtime enforcement claim). Current bounded policy closure baseline is `docs/roadmap/policy_ecology_closure.md` (P7, no runtime/action/gateway/mutation/prod-readiness claim). Post-policy planning selection is tracked in `docs/roadmap/post_policy_roadmap_selection.md` (POST-P, selection-only; primary next line: Evidence/Archive read-only query roadmap). Linux-only platform boundary authority is tracked in `docs/roadmap/linux_only_target_boundary_windows_portability_audit.md` (required CI/deployment target: Linux x86_64; Windows unsupported/deferred). The Module implementation depth registry is now available at `docs/module_implementation_depth_registry.md` and is required reading before Minimal Spine planning. Code and currently passing gates remain the final source of truth. Minimal UCF Spine v1 is now specified at `docs/minimal_ucf_spine_v1.md`; Prompt 5 must follow that spec.
...
| `docs/roadmap/replay_scheduler_roadmap_boundary_audit.md` | Current authoritative architecture docs | yes | Current planning and boundary audit for the next Replay Scheduler line; inventories existing replay audit/recompute code, replay-facing types, consolidation inputs, and deferred Sleep/Geist/ISM/identity/Gateway boundaries without implementing scheduler behavior. | `runtime/ucf-replay`, `domains/consolidation`, `core/crates/ucf-types`, `core/crates/ucf-evidence`, `domains/archive`, `domains/geist` | canonical-planning |
| `docs/roadmap/replay_record_authority_schema_alignment.md` | Current authoritative architecture docs | yes | Current Prompt 37 authority decision for replay-facing records; chooses split authority, classifies token/scheduled/applied vs audit-only records, and defines Prompt 38 token-builder acceptance criteria without scheduler/apply/archive behavior. | `runtime/ucf-replay`, `core/crates/ucf-types`, `core/crates/ucf-commit`, `protocol/crates/ucf-protocol`, `domains/consolidation`, `core/crates/ucf-evidence`, `domains/archive`, `domains/geist` | canonical-planning |
| `docs/roadmap/replay_closure.md` | Current authoritative architecture docs | yes | Prompt 44 closure baseline for the bounded deterministic Replay line; records validation of token builder, schedule builder, verify-only audit, local applied boundary, E2E determinism, workspace evidence, and split-evidence gate status without runtime replay, scheduler, Sleep/Geist/ISM, identity, Gateway, or Evidence/Archive append claims. | `runtime/ucf-replay`, `domains/consolidation`, `domains/geist`, `runtime/ucf-ops` | canonical-closure |
| `docs/roadmap/post_replay_roadmap_selection.md` | Current authoritative architecture docs | yes | Current post-Replay planning selection; recommends a docs-only Sleep Integration Roadmap and Boundary Audit as the next primary line, with Replay Evidence/Archive append contract as secondary, Prod-profile/workspace evidence stability as parallel, and Geist/ISM, Runtime Replay Scheduler, and schema evolution deferred unless explicitly selected later. | `runtime/ucf-replay`, `core/crates/ucf-sleep-coordinator`, `domains/geist`, `runtime/ucf-ops`, `protocol/crates/ucf-protocol`, `.github/workflows` | canonical-planning |
| `docs/roadmap/sleep_integration_roadmap_boundary_audit.md` | Current authoritative architecture docs | yes | Current Sleep planning and boundary audit; inventories existing sleep coordinator/report code, Replay audit/applied-boundary inputs, Geist/ISM risks, Evidence/Archive authority limits, Prompt 47-56 Sleep prompt series, and the Prompt 52 overclaim guard for the bounded candidate → verify-only audit → local boundary → E2E chain without implementing runtime Sleep behavior. | `core/crates/ucf-sleep-coordinator`, `core/crates/ucf-rsa`, `core/crates/ucf-tcf`, `runtime/ucf-replay`, `domains/geist`, `domains/consolidation`, `runtime/ucf-ops`, `.github/workflows` | canonical-planning |
| `docs/roadmap/sleep_closure.md` | Current authoritative architecture docs | yes | Prompt 53 closure baseline for the bounded Sleep line; records validation of deterministic Replay-derived SleepPlanCandidate, verify-only SleepPlanAudit, local SleepAppliedBoundary, Sleep E2E determinism, Replay/Geist/Consolidation related tests, workspace evidence, and split-evidence readiness-gate status without Sleep runtime, SleepCompleted, Geist/ISM, identity, Gateway, or Evidence/Archive append claims. | `core/crates/ucf-sleep-coordinator`, `runtime/ucf-replay`, `domains/geist`, `domains/consolidation`, `runtime/ucf-ops` | canonical-closure |
| `docs/roadmap/post_sleep_roadmap_selection.md` | Current authoritative architecture docs | yes | Current post-Sleep planning selection; selects Geist/ISM Roadmap and Boundary Audit as the primary next line, Evidence/Archive Append Contracts for Replay/Sleep as secondary, Prod-profile/workspace evidence stability as parallel, and defers Runtime Scheduler/Queue, Protocol Schema/Provenance Evolution, and Gateway Read API expansion until explicit boundaries are clearer. | `domains/geist`, `core/crates/ucf-sleep-coordinator`, `runtime/ucf-replay`, `domains/consolidation`, `core/crates/ucf-evidence`, `domains/archive`, `runtime/ucf-ops`, `.github/workflows` | canonical-planning |
| `docs/roadmap/geist_ism_roadmap_boundary_audit.md` | Current authoritative architecture docs | yes | Current Geist/ISM planning and boundary audit plus Prompt 61 overclaim guard; inventories existing SelfState, Geist loop, ISM upsert, archive append, Sleep coupling, bounded Sleep/Replay/Consolidation provenance, and identity-anchor risks while recording the tested candidate-only projection, verify-only audit, local ISM candidate boundary, bounded Geist/ISM E2E determinism, and later audit/provenance append/readback guard without runtime Geist, ISM write/upsert, identity anchor/finalization, memory stabilization, Gateway authority, Policy mutation, or second-event-log authority. | `domains/geist`, `core/crates/ucf-sleep-coordinator`, `runtime/ucf-replay`, `domains/consolidation`, `core/crates/ucf-evidence`, `domains/archive`, `runtime/ucf-ops`, `.github/workflows` | canonical-planning |
| `docs/roadmap/geist_ism_record_authority_schema_alignment.md` | Current authoritative architecture docs | yes | Geist/ISM record-authority alignment; records existing SelfState/Geist/ISM/identity surfaces and current bounded `ucf-geist` artifacts: `MinimalSpineGeistProjectionCandidate` candidate-only, `MinimalSpineGeistProjectionAudit` verify-only, `MinimalSpineIsmCandidateBoundary` local read-model/candidate-only, and bounded Geist/ISM E2E determinism. Existing ISM upsert, Archive append, Sleep mutation, Policy mutation, Gateway action, memory stabilization, and identity-anchor/finalization behavior remain deferred. | `domains/geist`, `core/crates/ucf-sleep-coordinator`, `runtime/ucf-replay`, `domains/consolidation`, `core/crates/ucf-evidence`, `domains/archive`, `core/crates/ucf-policy-ecology` | canonical-planning |
| `docs/roadmap/geist_ism_closure.md` | Current authoritative architecture docs | yes | Prompt 62 bounded Geist/ISM closure baseline with historical status note; records PASS evidence for projection candidate, verify-only audit, local ISM candidate boundary, bounded Geist/ISM E2E, Sleep/Replay/Consolidation regressions, workspace/clippy/docs/readiness-spine, workspace-test evidence, and split-evidence readiness-gate without claiming Geist runtime, ISM write/upsert, identity anchor/finalization, memory stabilization, Gateway/action authority, production readiness, or second-event-log authority. | `domains/geist`, `core/crates/ucf-sleep-coordinator`, `runtime/ucf-replay`, `domains/consolidation`, `runtime/ucf-ops` | canonical-closure |
| `docs/roadmap/post_geist_roadmap_selection.md` | Current authoritative architecture docs | yes | Current post-Geist planning selection; recommends Evidence/Archive Append Contracts for Replay/Sleep/Geist/ISM as the primary next line, Protocol Schema / Provenance Evolution as secondary, Prod-profile/workspace evidence stability as parallel, and Runtime Scheduler/Queue, Identity Anchor Authority, and Gateway Read API expansion as deferred. | `core/crates/ucf-evidence`, `domains/archive`, `runtime/ucf-replay`, `core/crates/ucf-sleep-coordinator`, `domains/geist`, `protocol/crates/ucf-protocol`, `runtime/ucf-ops`, `.github/workflows` | canonical-planning |
| `docs/roadmap/sleep_record_authority_schema_alignment.md` | Current authoritative architecture docs | yes | Sleep-facing record authority alignment; records that `MinimalSpineSleepPlanCandidate`, verify-only `MinimalSpineSleepPlanAudit`, local-only `MinimalSpineSleepAppliedBoundary`, and bounded Sleep E2E determinism now exist while canonical `SleepPlan`/`SleepCycle`/`SleepCompleted`/protocol `SleepApplied` schemas, runtime Sleep, Geist/ISM, identity, Gateway, and Evidence/Archive append behavior remain deferred. | `core/crates/ucf-sleep-coordinator`, `core/crates/ucf-rsa`, `runtime/ucf-replay`, `domains/geist`, `core/crates/ucf-types`, `protocol/crates/ucf-protocol`, `core/crates/ucf-evidence`, `domains/archive` | canonical-planning |
...
| `docs/roadmap/readiness_gate_timeout_stability_audit.md` | Current authoritative architecture docs | yes | Operational/readiness risk audit for Prompt 35A/35C; isolates local readiness-gate timeout to the internal workspace-test phase, records stale-report handling, and records readiness-spine drift closure without weakening gates. | `runtime/ucf-ops`, `.github/workflows`, `out/` reports | canonical-planning-risk |
| `docs/roadmap/prod_profile_readiness_inventory_gap_report.md` | Current authoritative architecture docs | yes | Prompt 76 inventory-only prod-profile readiness gap report; compares test/prod expectations, classifies current SKIP/freshness gaps, and sets Prompt 77 scope without claiming prod readiness or weakening gates. | `runtime/ucf-ops`, `docs/readiness_gate.md`, `.github/workflows`, `out/` artifacts | canonical-planning-risk |
...
| `docs/roadmap/metabolic_hormone_control_layer_roadmap_boundary_audit.md` | Current authoritative architecture docs | yes | Current planning and boundary audit for the metabolic/hormone control line; inventories existing neuromod/hormone surfaces, documents deterministic state/update/output constraints, and defines M2-M8 sequence without introducing runtime scheduler authority, policy mutation, identity finalization, Gateway authority, ISM write/upsert, or Evidence/Archive append side effects. | `domains/ucf-neuromod`, `runtime/ucf-replay`, `core/crates/ucf-sleep-coordinator`, `domains/geist`, `domains/consolidation`, `runtime/ucf-ops` | canonical-planning |
...
| `docs/readiness_spine_v8.md` and `docs/readiness_lock_sweep_v21.md` | Ambiguous / needs decision | partial operational lineage | Names imply authority; Prompt 35C closed current readiness-spine operator-surface drift, but these docs still require HEAD freshness and gate context before reuse. | readiness gates | ambiguous-review-needed |
...
| Evidence / Archive Append Contracts Roadmap | current-planning plus bounded implementation guard | `docs/roadmap/evidence_archive_append_contracts_roadmap_boundary_audit.md`, `docs/roadmap/evidence_archive_append_readback_closure.md` | `core/crates/ucf-evidence`, `domains/archive/crates/ucf-archive`, `domains/archive/crates/ucf-archive-store`, `runtime/ucf-replay`, `core/crates/ucf-sleep-coordinator`, `domains/geist/crates/ucf-geist` | Prompt 64 roadmap/boundary audit plus Prompt 65-68 completion notes | bounded audit/provenance append/readback only | Documents implemented Replay/Sleep/Geist/ISM audit-provenance append/readback and cross-layer readback E2E while preserving Evidence/Archive authority. | Overclaiming append as runtime, identity, Gateway, ISM write/upsert, production readiness, Minimal Spine v1.x change, or a second event log. |
| Evidence / Archive / Event Log | current-core | `docs/active_evidence_v3.md`, `docs/artifact_convention_v0.md`, `docs/proof_carrying_logs.md`, `docs/roadmap/evidence_archive_append_contracts_roadmap_boundary_audit.md` | `core/crates/ucf-evidence`, `core/crates/ucf-events`, `crates/replay_evidence`, archive/artifact crates | evidence refresh reports | deferred remote/archive concepts | Confusing generated reports or bounded append/readback with runtime, identity, Gateway, production, or second-event-log authority. |
...
| Metabolic / Neuromod / HPA / DBM | partial-prototype with bounded M1-M8 metabolic closure baseline | `docs/roadmap/metabolic_hormone_control_layer_roadmap_boundary_audit.md`, `docs/roadmap/metabolic_hormone_control_layer_closure.md`, `docs/biophys_neuro.md`, Blue-Brain boundary docs | `domains/ucf-neuromod`, `domains/ucf-dbm`, `crates/dbm_*`, `hpa` | Blue-Brain BR/BB/MD sweeps | HH pilot docs | Current metabolic claim is limited to bounded deterministic `HormoneStateV1` + update + advisory modulation + replay/sleep candidates + verify-only audit with M8 closure baseline; runtime scheduler integration, direct Replay/Sleep/Geist wiring, policy mutation, Gateway/action authority, identity authority, and metabolic-lane Evidence/Archive append remain deferred. |
| Consolidation Kernel | current-supporting | `docs/roadmap/full_consolidation_roadmap_boundary_audit.md`, `docs/roadmap/consolidation_record_authority_schema_alignment.md`, `docs/roadmap/full_consolidation_closure.md`, `docs/architecture/COHERENCE_LOOP.md` | `domains/consolidation/crates/ucf-consolidation`, `core/crates/ucf-commit`, `core/crates/ucf-sleep-coordinator` | Blue-Brain consolidation refreshes | bounded retrieval/consolidation candidate docs | Historical consolidation closure interpreted as current implementation depth; current claims stop at Micro/Meso explicit append/readback, Macro candidate, and local consolidation-level finalization with no Replay/Sleep/Geist/ISM/identity readiness; Prompt 35D adds strict split workspace-test evidence semantics; consolidation closure still requires fresh workspace-test evidence plus a fresh readiness-gate pass before being used as replay readiness. |
| Geist / Self-State / ISM / Recursion | bounded-local-chain plus broad prototype surfaces | `docs/roadmap/geist_ism_roadmap_boundary_audit.md`, `docs/roadmap/geist_ism_record_authority_schema_alignment.md`, `docs/architecture/interfaces.md`, `docs/module_map.md` | `domains/geist/crates/ucf-geist`, `core/crates/ucf-ism`, `core/crates/ucf-recursion-controller` | self-state historical docs if present | research recursion docs | Current claim stops at candidate-only `MinimalSpineGeistProjectionCandidate`, verify-only `MinimalSpineGeistProjectionAudit`, local read-model/candidate-only `MinimalSpineIsmCandidateBoundary`, bounded Geist/ISM E2E determinism, and Prompt 67 Evidence/Archive append/readback as audit/provenance persistence only; no runtime Geist, ISM write/upsert, IdentityAnchor, IdentityFinalization, memory stabilization, Policy mutation, Gateway/action authority, persistent self authority, production readiness, or second event log. |
| Policy Ecology / Normative Field | current-supporting (bounded P3-P5 chain) | `docs/roadmap/policy_ecology_roadmap_boundary_audit.md`, `docs/roadmap/policy_record_authority_schema_alignment.md`, `docs/policy_packs.md`, `docs/policy_key_registry.md` | `core/crates/ucf-policy-ecology`, `protocol/crates/ucf-protocol`, `policies/` | governance sweeps | experimental overlays | Current claims are bounded to PolicyFieldV1 read-only snapshot, PolicyEvaluationCandidateV1 candidate-only evaluation, and PolicyVerifyAuditV1 verify-only audit; runtime enforcement, action/gateway authority, policy mutation, identity authority, and Evidence/Archive authority remain deferred/absent. |
...
| Replay / Goldens / Drift | current-operational with bounded chain only | `docs/replay-harness.md`, `docs/replay_audit.md`, `docs/golden_update.md`, `docs/adversarial_harness.md`, `docs/roadmap/replay_scheduler_roadmap_boundary_audit.md`, `docs/roadmap/replay_record_authority_schema_alignment.md`, `docs/roadmap/replay_closure.md` | `runtime/ucf-replay`, `runtime/ucf-replay/tests/minimal_spine_replay_token_builder.rs`, `runtime/ucf-replay/tests/minimal_spine_replay_schedule_builder.rs`, `runtime/ucf-replay/tests/minimal_spine_replay_audit_contract.rs`, `runtime/ucf-replay/tests/minimal_spine_replay_applied_boundary.rs`, `runtime/ucf-replay/tests/minimal_spine_replay_e2e.rs`, `crates/replay_executor`, `crates/replay_evidence`, test/golden fixtures | drift/nightly reports | Runtime Replay Scheduler/queue/worker, Sleep/Geist/ISM/identity runtime integration, and Gateway-visible replay remain deferred | Current replay claims stop at token intent/reference, schedule planned ordering, audit verify-only, local replay-subsystem applied boundary, bounded E2E determinism, Prompt 65 audit/provenance append/readback, and the Prompt 44 bounded-closure validation baseline; stale drift reports or consolidation E2E tests are not proof of runtime replay readiness. |
| Real Compute / AI Backends / Burn / Candle / Toy / Stub | experimental | `docs/feature_matrix.md`, `docs/backends.md`, `docs/models_eligibility_v3.md`, `docs/backend_evidence_snapshot_v4.md`, `docs/roadmap/compute_feature_ci_matrix.md`, `docs/roadmap/real_compute_lane_inventory.md`, `docs/roadmap/real_compute_optional_lane_closure.md`, `docs/roadmap/optional_real_runtime_artifact_fixture_inventory.md`, `docs/roadmap/optional_real_runtime_pinned_local_fixture_plan.md`, `docs/roadmap/optional_real_runtime_artifact_format_decision.md` | `runtime/ucf-compute`, `domains/ai*`, `runtime/ucf-ebm-train`, backend crates | real-compute readiness sweeps | `docs/real_compute_*`, `docs/backend_burn_*`, `docs/backend_candle_*` | Feature existence mistaken for enabled real-compute production lane; use stub fixture/toy golden/optional-real compile-only taxonomy and Prompt 24 closure scope. |
...
| Ops / Reports / Artifact Conventions | current-operational | `docs/artifact_convention_v0.md`, `docs/readiness_gate.md`, `docs/runbooks.md`, `docs/attested_runs.md`, `docs/roadmap/readiness_gate_timeout_stability_audit.md` | `runtime/ucf-ops`, `out/` generated artifacts | committed/generated historical reports | none primary | Root report self-reference and stale HEAD metadata; Prompt 35B adds readiness-gate progress/timing observability, Prompt 35D adds mandatory fresh workspace-test evidence validation, and Prompt 35E adds workspace-test-check subphase progress/timing without weakening gate criteria. |
...
- Use the replay roadmap, record-authority alignment guard, Prompt 44 closure baseline, and the Evidence/Archive append roadmap before making replay claims; the bounded Replay line proves deterministic local Token→Schedule→Audit→AppliedBoundary validation plus Prompt 65 audit/provenance append/readback only, not runtime apply, scheduler/queue/worker, Sleep/Geist/ISM/identity runtime integration, Gateway readiness, production replay readiness, or a second event log.
- Use the Geist/ISM roadmap, record-authority alignment, Prompt 61 overclaim guard, and the Evidence/Archive append roadmap before making Geist/ISM/Self-State/identity claims; the bounded Geist/ISM line proves only candidate-only projection, verify-only audit, local read-model/candidate boundary, E2E determinism, and Prompt 67 audit/provenance append/readback, not runtime Geist, ISM write/upsert, identity anchor/finalization, memory stabilization, Policy mutation, Gateway/action authority, production readiness, or a second event log.
- Use the metabolic hormone roadmap overclaim guard before making metabolic/neuromod runtime claims; current allowed claims stop at bounded deterministic M2-M6 state/update/modulation/candidate/audit contracts and explicitly exclude runtime scheduler activation, Replay/Sleep/Geist direct wiring, policy mutation, Gateway/action authority, identity authority, and metabolic-lane Evidence/Archive append authority until a later explicit prompt.
...
| `docs/roadmap/ucf_architecture_to_repo_completion_matrix.md` | Current authoritative architecture docs | yes | Bounded architecture-to-repo completion matrix; records the Evidence/Archive Query Layer as `CLOSED_BOUNDED` for EAQ6 targeted closure only, without Gateway API, append/write, action/identity/runtime, second-event-log, full-workspace/clippy, or prod-readiness claims. | `docs/roadmap/evidence_archive_query_layer_closure.md`, `domains/geist/crates/ucf-geist` | canonical-planning |
| `docs/roadmap/evidence_archive_query_layer_closure.md` | Current authoritative architecture docs | yes | EAQ6 bounded closure baseline for the Evidence/Archive query line; confirms targeted `ucf-geist` query candidate/audit/readback validation and docs lint while explicitly excluding Gateway Read API, append/write authority, action/identity/runtime authority, a second event log, and prod-readiness claims. | `domains/geist/crates/ucf-geist`, `docs/roadmap/evidence_archive_query_layer_roadmap_boundary_audit.md`, `docs/roadmap/evidence_archive_query_record_authority_schema_alignment.md` | canonical-planning |
| `docs/roadmap/evidence_archive_query_record_authority_schema_alignment.md` | Current authoritative architecture docs | yes | EAQ2 authority alignment for the Evidence/Archive query line: read primitives are limited to `EvidenceStore::get` plus `ArchiveStore::get`/`iter_kind`/`root_commit`; append/gateway/identity authority remains forbidden/deferred; bounded query source set is `RecordKind::Other(65/66/67)` only; EAQ3 is the implementation next step. | `core/crates/ucf-evidence`, `domains/archive/crates/ucf-archive-store`, `runtime/ucf-replay`, `core/crates/ucf-sleep-coordinator`, `domains/geist/crates/ucf-geist`, `runtime/ucf-ops` | canonical-planning |
| `docs/roadmap/evidence_archive_query_layer_roadmap_boundary_audit.md` | Current authoritative architecture docs | yes | EAQ1 roadmap/boundary audit for a bounded read-only Evidence/Archive query layer; inventories existing readback APIs and defines allowed/forbidden query semantics without introducing append/write paths, Gateway/action authority, runtime execution, identity effects, policy mutation, or prod-readiness claims. | `core/crates/ucf-evidence`, `domains/archive/crates/ucf-archive-store`, `runtime/ucf-replay`, `core/crates/ucf-sleep-coordinator`, `domains/geist/crates/ucf-geist`, `runtime/ucf-ops` | canonical-planning |
