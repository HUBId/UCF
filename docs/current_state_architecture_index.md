...
| Metabolic / Neuromod / HPA / DBM | partial-prototype with bounded M2-M6 metabolic chain | `docs/roadmap/metabolic_hormone_control_layer_roadmap_boundary_audit.md`, `docs/biophys_neuro.md`, Blue-Brain boundary docs | `domains/ucf-neuromod`, `domains/ucf-dbm`, `crates/dbm_*`, `hpa` | Blue-Brain BR/BB/MD sweeps | HH pilot docs | Current metabolic claim is limited to bounded deterministic `HormoneStateV1` + update + advisory modulation + replay/sleep candidates + verify-only audit (M2-M6); runtime scheduler integration, direct Replay/Sleep/Geist wiring, policy mutation, Gateway/action authority, identity authority, and metabolic-lane Evidence/Archive append remain deferred. |
