...
- EAQ6 query closure baseline: `docs/roadmap/evidence_archive_query_layer_closure.md` is the current bounded Evidence/Archive query closure (no Gateway API claim, no append/write claim, no action/identity/runtime/prod-readiness claim).
