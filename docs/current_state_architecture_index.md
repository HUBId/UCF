...
| `docs/roadmap/consolidation_record_authority_schema_alignment.md` | Current authoritative architecture docs | yes | Defines current Micro/Meso/Macro record-authority and schema-alignment boundaries before builder implementation. | `domains/consolidation/`, `protocol/crates/ucf-protocol`, Evidence/Archive boundaries | canonical-planning |
