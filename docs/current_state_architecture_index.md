...
| `docs/roadmap/geist_ism_roadmap_boundary_audit.md` | Current authoritative architecture docs | yes | Current Geist/ISM planning and boundary audit plus Prompt 61 overclaim guard; inventories existing SelfState, Geist loop, ISM upsert, archive append, Sleep coupling, bounded Sleep/Replay/Consolidation provenance, and identity-anchor risks while recording the tested candidate-only projection, verify-only audit, local ISM candidate boundary, and bounded Geist/ISM E2E determinism without runtime Geist, ISM write/upsert, identity anchor/finalization, memory stabilization, Gateway authority, Policy mutation, or Evidence/Archive append. | `domains/geist`, `core/crates/ucf-sleep-coordinator`, `runtime/ucf-replay`, `domains/consolidation`, `core/crates/ucf-evidence`, `domains/archive`, `runtime/ucf-ops`, `.github/workflows` | canonical-planning |
...
| `docs/roadmap/geist_ism_closure.md` | Current authoritative architecture docs | yes | Prompt 62 bounded Geist/ISM closure baseline; records PASS evidence for projection candidate, verify-only audit, local ISM candidate boundary, bounded Geist/ISM E2E, Sleep/Replay/Consolidation regressions, workspace/clippy/docs/readiness-spine, workspace-test evidence, and split-evidence readiness-gate without claiming Geist runtime, ISM write/upsert, identity anchor/finalization, memory stabilization, Evidence/Archive append, Gateway/action authority, or production readiness. | `domains/geist`, `core/crates/ucf-sleep-coordinator`, `runtime/ucf-replay`, `domains/consolidation`, `runtime/ucf-ops` | canonical-closure |
...
| Evidence / Archive Append Contracts Roadmap | planning-current | `docs/roadmap/evidence_archive_append_contracts_roadmap_boundary_audit.md` | `core/crates/ucf-evidence`, `domains/archive/crates/ucf-archive`, `domains/archive/crates/ucf-archive-store`, `runtime/ucf-replay`, `core/crates/ucf-sleep-coordinator`, `domains/geist/crates/ucf-geist` | Prompt 64 roadmap/boundary audit | no implementation | Plans explicit Replay/Sleep/Geist/ISM audit-provenance append/readback contracts while preserving Evidence/Archive authority. | Overclaiming append as runtime, identity, Gateway, ISM write/upsert, production readiness, or a second event log. |
...
| Geist / Self-State / ISM / Recursion | bounded-local-chain plus broad prototype surfaces | `docs/roadmap/geist_ism_roadmap_boundary_audit.md`, `docs/roadmap/geist_ism_record_authority_schema_alignment.md`, `docs/architecture/interfaces.md`, `docs/module_map.md` | `domains/geist/crates/ucf-geist`, `core/crates/ucf-ism`, `core/crates/ucf-recursion-controller` | self-state historical docs if present | research recursion docs | Current claim stops at candidate-only `MinimalSpineGeistProjectionCandidate`, verify-only `MinimalSpineGeistProjectionAudit`, local read-model/candidate-only `MinimalSpineIsmCandidateBoundary`, and bounded Geist/ISM E2E determinism; no runtime Geist, ISM write/upsert, IdentityAnchor, IdentityFinalization, memory stabilization, Policy mutation, Evidence/Archive append, Gateway/action authority, persistent self authority, or production readiness. |
...
- Use the replay roadmap, record-authority alignment guard, and Prompt 44 closure baseline before making replay claims; the bounded Replay line proves deterministic local Token→Schedule→Audit→AppliedBoundary validation only, not runtime apply, scheduler/queue/worker, Sleep/Geist/ISM/identity, Evidence/Archive append, Gateway readiness, or production replay readiness.
- Use the Geist/ISM roadmap, record-authority alignment, and Prompt 61 overclaim guard before making Geist/ISM/Self-State/identity claims; the bounded Geist/ISM line proves only candidate-only projection, verify-only audit, local read-model/candidate boundary, and E2E determinism, not runtime Geist, ISM write/upsert, identity anchor/finalization, memory stabilization, Policy mutation, Evidence/Archive append, Gateway/action authority, or production readiness.
