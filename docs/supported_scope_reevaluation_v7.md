...
- `SupportedScopeExecutionV11` ist die autoritative Execution-Entscheidung.
- `supported-set-apply` akzeptiert in v16 nur Autorisierung aus aktuellem `SupportedScopeExecutionV11`.
