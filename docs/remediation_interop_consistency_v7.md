...
See `docs/remediation_spine_consistency_v8.md` for the stronger v8 spine-level cross-surface proof, `docs/primary_semantics_sweep_v9.md` for v9 canonical primary semantics authority, and `docs/final_primary_semantics_sweep_v10.md` for the final universal consumer sweep.
