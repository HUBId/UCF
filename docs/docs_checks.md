...
6. **Artifact schema snapshots up-to-date**
   - Regenerates shape snapshots for covered v3/v4/v5/v6/v7/v8/v9/v10/v11/v12/v13 governance/scope/readiness/review/export/interop artifacts and compares them with committed files in `docs/artifact_schema_snapshots/`.
