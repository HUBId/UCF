...
Ziel dieser Referenz ist eine **kanonische, reproduzierbare Audit-Baseline** für den aktuellen Blue-Brain-Stand nach BR6, IR1, MD2, MD3 und SC1, ohne neue Feature-Arbeit. Maßgeblicher HEAD für diesen Refresh ist `0c4d2170aecba56e37c746c6f3b8cbe404626c59`.
...
- **clean maintenance-ready baseline**
  ...
  - Reports liegen unter `out/blue_brain_audit_baseline_2026-05-09_head_0c4d2170ae/` und referenzieren HEAD `0c4d2170aecba56e37c746c6f3b8cbe404626c59`.
...
- **accepted tracked audit artifact**
  ...
  - Versionierte Baseline-Reports unter `out/blue_brain_audit_baseline_2026-05-09_head_0c4d2170ae/`.

- **historical baseline trace**
  - Ältere Baselines wie `out/blue_brain_audit_baseline_2026-05-02/`, `out/blue_brain_audit_baseline_2026-05-04/`, `out/blue_brain_audit_baseline_2026-05-08/`, die unqualifizierte Same-Day-Vorgänger-Baseline `out/blue_brain_audit_baseline_2026-05-09/` und frühere HEAD-qualifizierte Same-Day-Läufe wie `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/`, `out/blue_brain_audit_baseline_2026-05-09_head_895c3d1175/`, `out/blue_brain_audit_baseline_2026-05-09_head_9f263aac7e/` und `out/blue_brain_audit_baseline_2026-05-09_head_ffa017d613/`.
...
2. `cargo run -p ucf-ops -- docs lint --strict --out ./out/blue_brain_audit_baseline_2026-05-09_head_0c4d2170ae/docs_lint_report.json`
3. `cargo run -p ucf-ops -- readiness-gate --profile test --out ./out/blue_brain_audit_baseline_2026-05-09_head_0c4d2170ae/gate_report.json`
...
Die beiden aktuellen Gate-Reports (`out/gate_report.json` und `out/blue_brain_audit_baseline_2026-05-09_head_0c4d2170ae/gate_report.json`) tragen `code_version_tag = 0c4d2170aecba56e37c746c6f3b8cbe404626c59`.
...
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/`, `out/blue_brain_audit_baseline_2026-05-09_head_895c3d1175/`, `out/blue_brain_audit_baseline_2026-05-09_head_9f263aac7e/` und `out/blue_brain_audit_baseline_2026-05-09_head_ffa017d613/` bleiben frühere HEAD-qualifizierte Same-Day-Evidence; maßgeblich ist `out/blue_brain_audit_baseline_2026-05-09_head_0c4d2170ae/`.
...
Die aktuelle Evidence-/Baseline-Abschlussnotiz liegt unter `docs/blue_brain_final_evidence_baseline_refresh_2026_05_09.md` und bestätigt den Status **clean maintenance-ready baseline** auf HEAD `0c4d2170aecba56e37c746c6f3b8cbe404626c59`.
