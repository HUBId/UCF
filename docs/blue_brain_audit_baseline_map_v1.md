...
Ziel dieser Referenz ist eine **kanonische, reproduzierbare Audit-Baseline** für den aktuellen Blue-Brain-Stand nach BR6, IR1, MD2, MD3 und SC1, ohne neue Feature-Arbeit. Maßgeblicher HEAD für diesen Refresh ist `13615edd74b3e4da27036ceb82b45c78e85b0770`.
...
- **clean maintenance-ready baseline**
  ...
  - Reports liegen unter `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/` und referenzieren HEAD `13615edd74b3e4da27036ceb82b45c78e85b0770`.
...
- **accepted tracked audit artifact**
  ...
  - Versionierte Baseline-Reports unter `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/`.

- **historical baseline trace**
  - Ältere Baselines wie `out/blue_brain_audit_baseline_2026-05-02/`, `out/blue_brain_audit_baseline_2026-05-04/`, `out/blue_brain_audit_baseline_2026-05-08/` und die unqualifizierte Same-Day-Vorgänger-Baseline `out/blue_brain_audit_baseline_2026-05-09/`.
...
2. `cargo run -p ucf-ops -- docs lint --strict --out ./out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/docs_lint_report.json`
3. `cargo run -p ucf-ops -- readiness-gate --profile test --out ./out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/gate_report.json`
...
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/head_status.log`
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/cargo_test_workspace.log`
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/docs_lint.log`
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/docs_lint_report.json`
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/docs_lint_root.log`
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/readiness_gate.log`
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/readiness_gate_root.log`
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/gate_report.json`
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/cargo_fmt_check.log`
- `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/cargo_clippy_workspace.log`
- `out/docs_lint_report.json`
- `out/gate_report.json`

Die beiden aktuellen Gate-Reports (`out/gate_report.json` und `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/gate_report.json`) tragen `code_version_tag = 13615edd74b3e4da27036ceb82b45c78e85b0770`.
...
- `out/blue_brain_audit_baseline_2026-05-09/` bleibt eine unqualifizierte Same-Day-Vorgänger-Spur und ist durch `out/blue_brain_audit_baseline_2026-05-09_head_13615edd74/` als aktuelle operative Evidence abgelöst.
...
Die aktuelle Evidence-/Baseline-Abschlussnotiz liegt unter `docs/blue_brain_final_evidence_baseline_refresh_2026_05_09.md` und bestätigt den Status **clean maintenance-ready baseline** auf HEAD `13615edd74b3e4da27036ceb82b45c78e85b0770`.
