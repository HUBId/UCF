...
v15 extends residual-free governance guarantees into the ultimate canonical consumer sweep so terminal governance inputs are the only authoritative source.
