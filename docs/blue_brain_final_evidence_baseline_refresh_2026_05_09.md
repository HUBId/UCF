...
- Maßgeblicher Baseline-Lauf: `out/blue_brain_audit_baseline_2026-05-09/`
- Referenzierter HEAD: `efbeec23b752744dc9f87a2e2e3eeb9efe25104f`
...
Der Refresh erzeugt bzw. synchronisiert die aktuellen Root-Reports und die gebündelte Baseline unter `out/blue_brain_audit_baseline_2026-05-09/`:
...
`out/gate_report.json` und `out/blue_brain_audit_baseline_2026-05-09/gate_report.json` tragen beide `code_version_tag = efbeec23b752744dc9f87a2e2e3eeb9efe25104f`.
...
4. `cargo run -p ucf-ops -- docs lint --strict --out ./out/blue_brain_audit_baseline_2026-05-09/docs_lint_report.json`
5. `cargo run -p ucf-ops -- readiness-gate --profile test --out ./out/blue_brain_audit_baseline_2026-05-09/gate_report.json`
...
`out/blue_brain_audit_baseline_2026-05-09/cargo_fmt_check.log` ist bewusst maintenance-facing lesbar. Der Log enthält:
...
- Aktuelle operative Evidence ist ausschließlich der 2026-05-09-Lauf plus die Root-Reports `out/docs_lint_report.json` und `out/gate_report.json`.
