...
- Maßgeblicher Baseline-Lauf: `out/blue_brain_audit_baseline_2026-05-09_head_c500cc14ae/`
- Referenzierter HEAD: `c500cc14ae5c3ba2347933ba959ef0a6629ceee3`
- Finaler Reproduzierbarkeitsstatus: **clean maintenance-ready baseline**
- Ankerregel: diese Baseline gilt exakt für den genannten Audit-Target-HEAD; spätere Commits/Merges sind erst nach einem neuen Refresh Teil einer neuen Baseline und entwerten diesen abgeschlossenen Anker nicht rückwirkend.
...
Der Refresh erzeugt bzw. synchronisiert die aktuellen Root-Reports und die gebündelte Baseline unter `out/blue_brain_audit_baseline_2026-05-09_head_c500cc14ae/`:
...
`out/gate_report.json` und `out/blue_brain_audit_baseline_2026-05-09_head_c500cc14ae/gate_report.json` tragen beide `code_version_tag = c500cc14ae5c3ba2347933ba959ef0a6629ceee3`.
...
4. `cargo run -p ucf-ops -- docs lint --strict --out ./out/blue_brain_audit_baseline_2026-05-09_head_c500cc14ae/docs_lint_report.json`
5. `cargo run -p ucf-ops -- readiness-gate --profile test --out ./out/blue_brain_audit_baseline_2026-05-09_head_c500cc14ae/gate_report.json`
...
10. Targeted Evidence-Konsistenzchecks gegen HEAD, Baseline-Map, README, SC1-/Evidence-Referenzen und `code_version_tag` (geloggt in `out/blue_brain_audit_baseline_2026-05-09_head_c500cc14ae/consistency_checks.log`)
...
`out/blue_brain_audit_baseline_2026-05-09_head_c500cc14ae/cargo_fmt_check.log` ist bewusst maintenance-facing lesbar. Der Log enthält:
...
- HEAD-qualifizierte Baseline-Reports und Logs: `out/blue_brain_audit_baseline_2026-05-09_head_c500cc14ae/`.

Alle ausgeführten Standard-, Hygiene- und Konsistenzchecks liefen erfolgreich. Alle neu erzeugten Reports/Logs/Baseline-Referenzen wurden auf den Audit-Target-HEAD gebunden. Der aktuelle `code_version_tag` liegt in den Gate-Reports auf `c500cc14ae5c3ba2347933ba959ef0a6629ceee3`. Damit ist der Stand auf dem aktuellen Merge-HEAD als **clean maintenance-ready baseline** belegbar; danach genügt normaler Maintenance-/Bugfix-/Cleanup-Modus.
